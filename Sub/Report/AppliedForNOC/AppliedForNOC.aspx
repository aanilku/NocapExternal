<%@ Page Title="" Language="C#" MasterPageFile="~/Sub/SubReportMaster.master" AutoEventWireup="true"
    CodeFile="AppliedForNOC.aspx.cs" Inherits="Sub_Report_AppliedForNOC_AppliedForNOC" %>
                    ...
                    <table width="100%" class="SubFormWOBG" style="line-height: 25px">
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <center>
                                    <rsweb:ReportViewer ID="RvResult" runat="server" Width="100%" AsyncRendering="false" ShowExportControls="false"
