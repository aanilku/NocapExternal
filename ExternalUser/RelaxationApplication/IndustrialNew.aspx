<%@ Page Title="NOCAP-Industrial Application" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="IndustrialNew.aspx.cs" Inherits="ExternalUser_RelaxationApplication_IndustrialNew" %>
        ...
        <tr>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                General Information- Location Details
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td style="width: 35%">Application Type : <span class="Coumpulsory">*</span>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlApplicationType" runat="server" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="ddlApplicationType_SelectedIndexChanged">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ForeColor="Red"
                                Display="Dynamic" ValidationGroup="LocationDetails" InitialValue="" ControlToValidate="ddlApplicationType">Required</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtUIDNumber" runat="server" MaxLength="100"></asp:TextBox>
                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ForeColor="Red"
                                ValidationGroup="LocationDetails" ControlToValidate="txtGSTNumber" Display="Dynamic">Required</asp:RequiredFieldValidator>--%>

                            <%--  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="LocationDetails"
                                Display="Dynamic" ForeColor="Red" ControlToValidate="txtGSTNumber"></asp:RegularExpressionValidator>--%>
                        </td>
                    </tr>
