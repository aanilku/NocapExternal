<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true" CodeFile="ViewOnlinePayment.aspx.cs" Inherits="ExternalUser_ViewOnlinePayment" %>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvPayment" runat="server" ShowHeaderWhenEmpty="true"
                                ...
                                OnRowEditing="gvPayment_RowEditing"
                                OnRowUpdating="gvPayment_RowUpdating" OnPageIndexChanging="gvPayment_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField ItemStyle-Width="15px">
                                        <ItemTemplate>
                                            <img alt="" style="cursor: pointer" src="../Images/plus.png" />
                                            <asp:Panel ID="pnlPaymentDetails" runat="server" Style="display: none">
                                                <table>
                                                    <tr>
                                                        <td></td>
                                                        <td colspan="100%">

                                                            <asp:GridView runat="server" CssClass="SubFormWOBG" ID="gvPaymentDetails" ShowHeaderWhenEmpty="true"
        ...
        <tr>
            <td>
                <table style="width: 100%; align-content: center" class="SubFormWOBG">
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvPaymentHist" runat="server" ShowHeaderWhenEmpty="true"
                                AutoGenerateColumns="False"
                                Width="100%" DataKeyNames="ApplicationCode,OrderPaymentCode" CssClass="SubFormWOBG"
                                OnRowDataBound="gvPaymentHist_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Details">
                                        <ItemTemplate>
                                            <asp:GridView runat="server" CssClass="SubFormWOBG" ID="gvPaymentDetailsHist" ShowHeaderWhenEmpty="true"
                                                AutoGenerateColumns="False" Width="100%">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Sr. No.">
                                                        <ItemTemplate>
