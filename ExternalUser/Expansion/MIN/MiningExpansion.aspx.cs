...
public partial class ExternalUser_Expansion_MIN_MiningExpansion : System.Web.UI.Page
{
    string strPageName = "MINMiningExpansion";
    ...
    private int UpdateGeneralInformationLocationDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            {
                case "Y":
                    obj_MiningNewApplication.MSME = NOCAP.BLL.Mining.Expansion.MiningExpansionApplication.MSMEYesNo.Yes;
                    break;
                case "N":
                    obj_MiningNewApplication.MSME = NOCAP.BLL.Mining.Expansion.MiningExpansionApplication.MSMEYesNo.No;
                    break;
            }
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    if (lblMiningApplicationCodeFrom.Text.Trim() != "") { Server.Transfer("~/ExternalUser/Expansion/MIN/CommunicationAddress.aspx"); }
                    else { }
                }
            }
        }
