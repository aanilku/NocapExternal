...
public partial class ExternalUser_Expansion_MIN_DetailsProposedGroundwaterAbstractionStructure : System.Web.UI.Page
{
    ...
    private void BindIGVMinNewProposedGWASDetails(long lngA_ApplicationCode)
    {
        ...
        NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure obj_minNewProposedGWASBlank = new NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure();
        List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure> lst_minNewProposedGWASBlank = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure>();
        List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure> lst_minNewProposedGWAS = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure>();
        ...
        try
        {
            ...
            NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure[] arr_minNewProposedGWAS;
            arr_minNewProposedGWAS = obj_MiningNewApplication.GetMiningExpansionProposedGroundWaterAbstractionStructureList();
            foreach (NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure test in arr_minNewProposedGWAS)
            {
    ...
    protected void btnPrev_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Page.IsValid)
            {
                Server.Transfer("~/ExternalUser/Expansion/MIN/DetailsExistingGroundwaterAbstractionStructure.aspx");
            }
        }
    }
    ...
    private int UpdateminNewProposedGWASDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningNewApplication = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(lngA_ApplicationCode);
            List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure> lst_minNewProposedGWASList = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure>();
            foreach (GridViewRow gvRow in gvGASProposed.Rows)
            {
                ...
                NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure obj_minNewProposedGWAS = new NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure();
            ...
            NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure[] arr_tempMinGwasProposedListBLL = new NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure[lst_minNewProposedGWASList.Count];
            lst_minNewProposedGWASList.CopyTo(arr_tempMinGwasProposedListBLL);
            obj_MiningNewApplication.MiningExpansionProposedGroundWaterAbstractionStructureList = arr_tempMinGwasProposedListBLL;
            if (txtNumbeOfProposedGAS.Text.Trim() == "")
            {
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Page.IsValid)
            {
                if (UpdateminNewProposedGWASDetails(Convert.ToInt64(lblMiningApplicationCodeFrom.Text)) == 1) { Server.Transfer("~/ExternalUser/Expansion/MIN/OtherDetails.aspx"); }
                else
                {
                }
            }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure obj_minNewProposedGWASBlankForGridToObj = new NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure();
                List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure> lst_minNewProposedGWASNewList = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure>();
                foreach (GridViewRow gvRow in gvGASProposed.Rows)
                {
                    obj_minNewProposedGWASBlankForGridToObj = new NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure();
    ...
    protected void gvGASProposed_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    obj_minNewProposedGWAS = new NOCAP.BLL.Mining.Expansion.MiningExpansionProposedGroundWaterAbstractionStructure(Convert.ToInt64(gvGASProposed.DataKeys[e.Row.RowIndex].Values[0].ToString()), Convert.ToInt32(lbl_SerialNumber.Text));
