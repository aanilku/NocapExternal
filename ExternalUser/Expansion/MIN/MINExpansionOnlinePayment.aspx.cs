...
public partial class ExternalUser_Expansion_MINExpansion_MINExpansionOnlinePayment : System.Web.UI.Page
{
    ...
    private void BindPaymentDetail(long lngA_ApplicationCode)
    {
        ...
        NOCAP.BLL.Master.FeeRequiredPending obj_FeeRequiredPending = new NOCAP.BLL.Master.FeeRequiredPending(obj_MiningNewSADApplication.ApplicationTypeCode, obj_MiningNewSADApplication.ApplicationPurposeCode);
        ...
        if (obj_MiningNewSADApplication.ProFeeOrderPaymentCode != null)
        {
            NOCAP.BLL.Misc.Payment.SADOnlinePayment obj_SADOnlinePayment = new NOCAP.BLL.Misc.Payment.SADOnlinePayment(lngA_ApplicationCode, obj_MiningNewSADApplication.ProFeeOrderPaymentCode.ToString());
    ...
    protected void PayBtn_Click(object sender, EventArgs e)
    {
        ...
        NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication obj_MiningNewSADApplication = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication(Convert.ToInt64(lblMiningApplicationCodeFrom.Text));


        NOCAP.BLL.Master.SubDistrict obj_subDistrict = new NOCAP.BLL.Master.SubDistrict(obj_MiningNewSADApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_MiningNewSADApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_MiningNewSADApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode);
        ...
        //{
        //    case "0":
        //        XMLstr = NOCAPExternalUtility.CreateXML(Convert.ToInt64(Session["ExternalUserCode"]), dict, (txtGWChargeArear.Text == "" ? ArearAmount : Convert.ToDecimal(txtGWChargeArear.Text)), NOCAP.BLL.Common.CommonEnum.PaymentMethodMode.OffLine, ref OrderPaymentCode, obj_MiningNewSADApplication: obj_MiningNewSADApplication);
        //        break;
        //    case "1":

        //        XMLstr = NOCAPExternalUtility.CreateXML(Convert.ToInt64(Session["ExternalUserCode"]), dict, (txtGWChargeArear.Text == "" ? ArearAmount : Convert.ToDecimal(txtGWChargeArear.Text)), NOCAP.BLL.Common.CommonEnum.PaymentMethodMode.OnLine, ref OrderPaymentCode, obj_MiningNewSADApplication: obj_MiningNewSADApplication);
        //        break;
        //    case "2":
        //        XMLstr = NOCAPExternalUtility.CreateXML(Convert.ToInt64(Session["ExternalUserCode"]), dict, (txtGWChargeArear.Text == "" ? ArearAmount : Convert.ToDecimal(txtGWChargeArear.Text)), NOCAP.BLL.Common.CommonEnum.PaymentMethodMode.NotDefined, ref OrderPaymentCode, obj_MiningNewSADApplication: obj_MiningNewSADApplication);
        //        break;
        //}
