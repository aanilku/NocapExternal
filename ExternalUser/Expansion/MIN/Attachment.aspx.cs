...
using NOCAP.BLL.Mining.Expansion;

public partial class ExternalUser_Expansion_MIN_Attachment : System.Web.UI.Page
{
    ...
    private void BindMiningNewApplicationAttachmentGroundWaterAvailabilityDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            else
            {
                ...
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningExpansionApplication = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(lngA_ApplicationCode);
                if (obj_MiningExpansionApplication.WaterQuality != NOCAP.BLL.Common.CommonEnum.WaterQualityOption.RannKuchch)
                {
    ...
    //        NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MIningNewApplication = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(lngA_ApplicationCode);
    //        NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment[] arr_MiningNewApplicationAttachmentList;
    //        arr_MiningNewApplicationAttachmentList = obj_MIningNewApplication.GetCopyOfReferralLetterAttachmentList(int_ReferralLetterAttachCode, NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment.SortingFieldForAttachment.NoSorting);
    ...
    //        NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter obj_MiningNewReferralLetter = new NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter(Convert.ToInt32(lblMiningApplicationCodeFrom.Text), Convert.ToInt32(ddlReferralLetter.SelectedValue));
    //        Count = Count + obj_MiningNewApplication.GetCopyOfReferralLetterAttachmentList(obj_MiningNewReferralLetter.ReferralLetterAttachCode, NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment.SortingFieldForAttachment.NoSorting).Length;
    //    }
    ...
    protected void btnPrev_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                Server.Transfer("~/ExternalUser/Expansion/MIN/OtherDetails.aspx");
            }
        }
    }
    #endregion
    ...
    protected void BharatKoshReciept_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment obj_miningNewApplicationAttachment = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment(lng_ApplicationCode, int_AttachmentCode, int_AttachmentCodeSerialNumber);
                if (obj_miningNewApplicationAttachment.Delete() == 1)
                {
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                if (arr_MiningNewApplicationAttachmentList.Count() < AttachmentNumberLimit())
                {
                    ...
                    NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningNewApplication = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(Convert.ToInt32(lblMiningApplicationCodeFrom.Text));
                    List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment> lst_MiningNewApplicationAttachmentList = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment>();
            ...
            else
            {
                ...
                if (arr_MiningNewApplicationAttachmentList.Count() < AttachmentNumberLimit())
                {
                    ...
                    try
                    {
                        ...
                        obj_insertMiningNewApplicationAttachment.ApplicationCode = obj_MiningNewApplication.ApplicationCode;
                        obj_insertMiningNewApplicationAttachment.AttachmentCode = obj_MiningNewApplication.MiningDewatering.GWFlowAttachCode;
    ...
    protected void btnUploadReferralLetter_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter obj_MiningNewReferralLetterk = new NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter(Convert.ToInt32(lblMiningApplicationCodeFrom.Text), int_ReferralLetterCode);
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningNewApplicationForNoLimit = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(Convert.ToInt32(lblMiningApplicationCodeFrom.Text));
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment[] arr_MiningNewApplicationAttachmentList;
                ...
                {
                    arr_MiningNewApplicationAttachmentList = obj_MiningNewApplicationForNoLimit.GetCopyOfReferralLetterAttachmentList(obj_MiningNewReferralLetterk.ReferralLetterAttachCode, NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment.SortingFieldForAttachment.NoSorting);
                ...
                if (int_CountAttForRefLetter < AttachmentNumberLimit())
                {
                    ...
                    try
                    {
                        ...
                        {
                            NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter obj_MiningNewReferralLetterForAdd = new NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter();
                        ...
                        NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment obj_insertMiningNewApplicationAttachmentAferAdd = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment();
                        NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningNewApplicationAfterAdd = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(Convert.ToInt32(lblMiningApplicationCodeFrom.Text));
                        List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment> lst_MiningNewApplicationAttachmentList = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationAttachment>();
                        byte[] buffer = new byte[1];
                        ...
                        lblMessageReferralLetter.ForeColor = Color.Green;
                        obj_MiningNewReferralLetter = new NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter(Convert.ToInt32(lblMiningApplicationCodeFrom.Text), Convert.ToInt32(ddlReferralLetter.SelectedValue));
    ...
    protected void ddlReferralLetter_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                int int_ReferralLetterCode = Convert.ToInt32(ddlReferralLetter.SelectedValue);
                NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter obj_MiningNewReferralLetter = new NOCAP.BLL.Mining.Expansion.MiningExpansionReferralLetter(Convert.ToInt32(lblMiningApplicationCodeFrom.Text), int_ReferralLetterCode);
                // BindMiningNewApplicationAttachmentRefferalLetterDetails(Convert.ToInt32(lblMiningApplicationCodeFrom.Text), obj_MiningNewReferralLetter.ReferralLetterAttachCode);
    ...
    void OTPVerifyEnavleDesable()
    {
        ...
        MiningExpansionApplication obj_MiningExpansionApplication = new MiningExpansionApplication(Convert.ToInt64(lblApplicationCode.Text));
        if (obj_MiningExpansionApplication != null && obj_MiningExpansionApplication.ApplicationCode > 0)
        {
            if (obj_MiningExpansionApplication.ImpactAssOCSOTPVerified == NOCAP.BLL.Industrial.New.Common.IndustrialNewApplicationB.ImpactAssOCSOTPVerifiedYesNo.Yes)
            {
                ddlConsultant.ClearSelection();
                ddlConsultant.Items.FindByValue(Convert.ToString(obj_MiningExpansionApplication.ImpactAssOCSOTPVerifiedByCC)).Selected = true;
                ddlConsultant.Enabled = false;
                txtImpactReportOCSOTP.Enabled = false;
                btnOTPVerify.Enabled = false;
                lblOTPVerified.Text = Convert.ToString(obj_MiningExpansionApplication.ImpactAssOCSOTPVerified);
    ...
    protected void btnOTPVerify_Click(object sender, EventArgs e)
    {
        ...
        {
            MiningExpansionApplication obj_MiningExpansionApplication = new MiningExpansionApplication(Convert.ToInt64(lblApplicationCode.Text));
            NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication obj_MiningExpansionApplication1 = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication(Convert.ToInt64(lblApplicationCode.Text));
            if (obj_MiningExpansionApplication.ApplicationCode > 0)
            {
                obj_MiningExpansionApplication.ImpactAssOCSOTPVerified = NOCAP.BLL.Industrial.New.Common.IndustrialNewApplicationB.ImpactAssOCSOTPVerifiedYesNo.Yes;
                obj_MiningExpansionApplication.ImpactAssOCSOTPVerifiedByCC = Convert.ToInt32(ddlConsultant.SelectedValue);
                obj_MiningExpansionApplication.ModifiedByExUC = Convert.ToInt64(Session["ExternalUserCode"]); ;
                int int_result = obj_MiningExpansionApplication1.SetImpactAssOCSOTPVerified();
                if (int_result == 1)
                {
    ...
    protected void btnSendOTP_Click(object sender, EventArgs e)
    {
        ...
        if (ddlConsultant.SelectedIndex > 0)
        {
            ...
            if (obj_ConsultantDetail != null && obj_ConsultantDetail.ConsultantCode > 0)
            {
                ...
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningExpansionApplication = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(Convert.ToInt64(lblApplicationCode.Text));
                if (obj_MiningExpansionApplication.ApplicationCode > 0)
                {

                    if (SMSUtility.IsSendSMSEnable())
                    {
                        OTPMessage = "Do not share OTP with anyone. OTP for submission of IAR / CHR to CGWA in respect of your application name : " + obj_MiningExpansionApplication.NameOfMining + " is :" + OTP;
                    ...
                    if (EmailUtility.IsSendEmailEnable())
                    {
                        ...
                        string str_StateName = new NOCAP.BLL.Master.State(obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode).StateName;
                        string str_DistrictName = new NOCAP.BLL.Master.District(obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode).DistrictName;
                        string str_SubDistrictName = new NOCAP.BLL.Master.SubDistrict(obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode).SubDistrictName;

                        if (obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown == NOCAP.BLL.Common.Address.VillageOrTownOption.Town)
                        {
                            str_TownName = "Town Name : ";
                            str_TownName = str_TownName + new NOCAP.BLL.Master.Town(obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.TownCode).TownName;
                            str_TownName = str_TownName + ", ";
                        }
                        if (obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown == NOCAP.BLL.Common.Address.VillageOrTownOption.Village)
                        {
                            str_VillageName = "Village Name : ";
                            str_VillageName = str_VillageName + new NOCAP.BLL.Master.Village(obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode, obj_MiningExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageCode).VillageName;
                            str_VillageName = str_VillageName + ", ";
                        }
                        //for Address


                        string strBody = "<table style='max-width: 600px;margin: auto;width: 100%;border: 1px solid #f9f9f9;'><tr><td style='padding:30px;' colspan='3'><p>Dear <span>" + obj_ConsultantDetail.ConsultantName + "</span></p><p>Your One Time Password (OTP) for submission of Impact Assessment Report / Comprehensive Hydrogeological Report to CGWA in respect of Application for <span style='font-style: italic;'> " + obj_MiningExpansionApplication.NameOfMining + ", " + str_VillageName + str_TownName + " Sub District : " + str_SubDistrictName + ", District : " + str_DistrictName + ", State : " + str_StateName + " </span> is mentioned below.</p><p>Please enter this OTP in the required field to proceed further.</p></td></tr><tr style='background-color: #1d65a3;'><td style='color: #fff;text-align: center; padding: 5px 0px;' colspan='3'>DETAILS</td></tr><tr><td style='padding-left: 30px;'><strong>One Time Password (OTP)</strong></td><td style='padding-right: 30px;' colspan='2'><strong>" + OTP + "</strong></td></tr><tr><td  colspan='3' style='padding:30px;'><p>The above mentioned OTP is valid for 15 minutes.</p><p>Sincerely, <br /><strong>CGWA, New Delhi</strong></p></td></tr></table>";


                        // string strBody = "<p>Sir/Madam,</p><p> </br></br>Do not share OTP with anyone. OTP for submission of IAR / CHR to CGWA in respect of your application name : " + obj_MiningExpansionApplication.NameOfMining + " is <span style='color: blue;'> " + OTP + "</span> </p><p><br />  This is an auto-generated email.&nbsp; Do not reply to this email.<br />  </p>";
