<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="SalientFeature.aspx.cs" Inherits="ExternalUser_Expansion_MIN_SalientFeature" %>
                    ...
                    <tr>
                        <td>
                            <div class="div_IndAppHeading" style="padding-left:10px">
                                MINING EXPANSION USE: 1. General Information- Exemption Letter
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <%--<td style="text-align:center">
                            ...
                            <asp:Button ID="btnSaveAsDraft" runat="server" Text="Save as Draft" 
                                onclick="btnSaveAsDraft_Click1" ValidationGroup="LandUseDetails" />
                            <asp:Button ID="btnSubmit" runat="server" onclick="btnSubmit_Click" 
                                Text="TestSubmit" ValidationGroup="LandUseDetails" style="height: 26px"/>
                        </td>--%>
                        <td style="text-align:center">
                            <asp:Button ID="btnPrev" runat="server" Text="<< Prev" OnClientClick="return confirm('If you have not saved data, Your data will be lost before moving to other page ?');"
                                onclick="btnPrev_Click" />
