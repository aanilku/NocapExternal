<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_Expansion_MIN_DetailsExistingGroundwaterAbstractionStructure" %>
                ...
                <div>
                    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                        <tr>
                            <td colspan="3">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    MINING EXPANSION USE: Groundwater Abstraction Structure- Existing
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td  colspan="2">
                               <b>Proposed Pump/ Pumping Groundwater Outside the Mine Pit for Domestic or Other Use (If so, give Details): </b>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 40%">
                                a) Number of Existing Structures: <span class="Coumpulsory">
                                    *</span>
                            </td>
                            <td>
