...
public partial class ExternalUser_Expansion_MIN_MINExpansionReadyToSubmit : System.Web.UI.Page
{
    string strActionName = "ReadyToSubmit", strStatus = "", strPageName = "MINNewReadyToSubmit";
    ...
    private void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Mining/New/PrintApplication/MiningSADApplication";
    ...
    protected void btnReadyToSubmitSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                {
                    if (obj_MiningNewApplication.ReadyToSubmitApplication(out lng_submittedApplicationCode, null, obj_externalUser.ExternalUserCode) == 1)
                    {
