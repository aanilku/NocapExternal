...
public partial class ExternalUser_Expansion_MIN_De_WateringProposedStructure : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (lblMiningApplicationCodeFrom.Text.Trim() != "") { BindIGVMinNewProposedDGWASDetails(Convert.ToInt64(lblMiningApplicationCodeFrom.Text)); }
            }
            catch (Exception)
            {
    ...
    private void BindIGVMinNewProposedDGWASDetails(long lngA_ApplicationCode)
    {
        ...
        NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure obj_minNewProposedDGWASBlank = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure();
        List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure> lst_minNewProposedDGWASBlank = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure>();
        List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure> lst_minNewProposedDGWAS = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure>();
        try
        {
            if (obj_MiningNewApplication.MiningDewatering.WhetherGWTableIntersected == NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationDewatering.GWTableIntersected.No) { DisableEnableForm(false); }
            ...
            NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure[] arr_minNewProposedDGWAS;
            arr_minNewProposedDGWAS = obj_MiningNewApplication.GetMiningExpansionProposedDeWateringAbstractionStructureList();
            foreach (NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure test in arr_minNewProposedDGWAS) { lst_minNewProposedDGWAS.Add(test); }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure obj_minNewProposedDGWASBlankForGridToObj = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure();
                List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure> lst_minNewProposedDGWASNewList = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure>();
                foreach (GridViewRow gvRow in gvdeWateringPrposed.Rows)
                {
                    obj_minNewProposedDGWASBlankForGridToObj = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure();
    ...
    protected void txtNext_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Page.IsValid)
            {
                ...
                {
                    Server.Transfer("~/ExternalUser/Expansion/MIN/ProposedUtiizationOfPumpedWater.aspx");
                }
                else
                {
                }
    ...
    private int UpdateMinNewProposedDGWASDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            NOCAP.BLL.Mining.Expansion.MiningExpansionApplication obj_MiningNewApplication = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplication(lngA_ApplicationCode);
            List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure> lst_minNewProposedDGWASList = new List<NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure>();
            foreach (GridViewRow gvRow in gvdeWateringPrposed.Rows)
            {
                Label lbl_TypeOfAbstractionStructureCode = (Label)gvRow.FindControl("TypeOfAbstractionStructureCode");
                Label lbl_YearOfConstruction = (Label)gvRow.FindControl("YearOfConstruction");
                ...
                Label lbl_WhetherPermissionRegisteredWithCGWA = (Label)gvRow.FindControl("WhetherPermissionRegisteredWithCGWA");
                Label lbl_WhetherPermissionRegisteredWithCGWADetails = (Label)gvRow.FindControl("WhetherPermissionRegisteredWithCGWADetails");
                NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure obj_minNewProposedDGWAS = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure();
            ...
            NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure[] arr_tempMinDeWateringProposedListBLL = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure[lst_minNewProposedDGWASList.Count];
    ...
    protected void gvdeWateringPrposed_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    obj_MinNewProposedDGWAS = new NOCAP.BLL.Mining.Expansion.MiningExpansionApplicationProposedDeWateringAbstractionStructure(Convert.ToInt64(gvdeWateringPrposed.DataKeys[e.Row.RowIndex].Values[0].ToString()), Convert.ToInt32(lbl_SerialNumber.Text));
