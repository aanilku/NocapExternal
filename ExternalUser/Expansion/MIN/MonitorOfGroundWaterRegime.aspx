<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" MaintainScrollPositionOnPostback="true"
    AutoEventWireup="true" CodeFile="MonitorOfGroundWaterRegime.aspx.cs" Inherits="ExternalUser_Expansion_MIN_MonitorOfGroundWaterRegime" %>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                MINING EXPANSION USE: Monitoring of Ground Water Regime
                            </div>
                        </td>
                    </tr>
                    <tr>
