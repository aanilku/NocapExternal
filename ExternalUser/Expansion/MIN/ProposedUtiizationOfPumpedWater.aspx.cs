...
public partial class ExternalUser_Expansion_MIN_ProposedUtiizationOfPumpedWater : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (lblMiningApplicationCodeFrom.Text.Trim() != "") { BindGVMinUtilizationPumpedWaterDetails(Convert.ToInt64(lblMiningApplicationCodeFrom.Text)); }
