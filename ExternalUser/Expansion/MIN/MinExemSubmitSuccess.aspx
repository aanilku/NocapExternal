<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="MinExemSubmitSuccess.aspx.cs" Inherits="ExternalUser_Expansion_MINExpansion_MinExemSubmitSuccess" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="padding-left:10px">
                                MINING Expansion USE : EXEMPTION
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <fieldset>
                                ...
                                <table width="100%" class="SubFormWOBG">
                                    ...
                                    <tr>
                                        <td>Sub District</td>
                                        <td><asp:Label ID="lblSubDistrict" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                </table>
                            </fieldset>
                            Quantity Applied for : <asp:Label ID="lblQuentity" runat="server" Text=""></asp:Label>
                              <br />
