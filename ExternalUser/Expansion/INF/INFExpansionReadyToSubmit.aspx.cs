...
public partial class ExternalUser_Expansion_INF_INFExpansionReadyToSubmit : System.Web.UI.Page
{
    string strActionName = "ReadyToSubmit", strStatus = "", strPageName = "INFNewReadyToSubmit";
    ...
    private void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Infrastructure/New/PrintApplication/InfrastructureSADApplication";
    ...
    protected void btnReadyToSubmitSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                {
                    if (obj_infrastructureNewApplication.ReadyToSubmitApplication(out lng_submittedApplicationCode, null, obj_externalUser.ExternalUserCode) == 1)
                    {
