...
public partial class ExternalUser_Expansion_INF_InfrastructureExpansion : System.Web.UI.Page
{
    string strPageName = "InfrastructureExpansion";
    ...
    private int UpdateGeneralInformationLocationDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            obj_infrastructureExpansionApplication.ApplicationTypeCategoryCode = Convert.ToInt32(ddlApplicationTypeCategory.SelectedValue);
            obj_infrastructureExpansionApplication.NameOfInfrastructure = txtNameOfInfraStructure.Text;
            obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.AddressLine1 = txtAddressLine1.Text;
            obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.AddressLine2 = txtAddressLine2.Text;
            obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.AddressLine3 = txtAddressLine3.Text;
            obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode = Convert.ToInt32(ddlState.SelectedValue);
            obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode = Convert.ToInt32(ddlDistrict.SelectedValue);
            obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode = Convert.ToInt32(ddlSubDistrict.SelectedValue);
            obj_infrastructureExpansionApplication.WaterQualityCode = Convert.ToInt32(ddlWaterQualityType.SelectedValue);
            //static ground waret - delete it
            //obj_infrastructureExpansionApplication.InfrastructurNewWaterRequirementRecycledUsesDetail.GroundWaterRequirement = Convert.ToDecimal(txtGroundWaterRequirement.Text);
            switch (ddlTownOrVillage.SelectedValue)
            {
                case "V":
                    if (NOCAPExternalUtility.IsNumeric(ddlVillage.SelectedValue))
                    {
                        obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageCode = Convert.ToInt32(ddlVillage.SelectedValue);
                        obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown = NOCAP.BLL.Common.Address.VillageOrTownOption.Village;
                    }
                    else { return 0; }
                    break;
                case "T":
                    ...
                    {
                        obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.TownCode = Convert.ToInt32(ddlTown.SelectedValue);
                        obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown = NOCAP.BLL.Common.Address.VillageOrTownOption.Town;
                    }
                    else { return 0; }
                    break;
            }
            ...
            {
                case "Y":
                    obj_infrastructureExpansionApplication.MSME = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.MSMEYesNo.Yes;
                    break;
                case "N":
                    obj_infrastructureExpansionApplication.MSME = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.MSMEYesNo.No;
                    break;
            }
            ...
            if (obj_infrastructureExpansionApplication.MSME == NOCAP.BLL.Infrastructure.New.Common.InfrastructureNewApplicationB.MSMEYesNo.Yes)
            {
                obj_infrastructureExpansionApplication.MSMETypeCode = Convert.ToInt32(ddMSMEType.SelectedValue);
            }
            else
            {
                obj_infrastructureExpansionApplication.MSMETypeCode = null;
            }

            switch (ddlWetlandArea.SelectedValue)
            {
                case "Y":
                    obj_infrastructureExpansionApplication.WetLandArea = NOCAP.BLL.Infrastructure.New.Common.InfrastructureNewApplicationB.WetLandAreaYesNo.Yes;
                    break;
                case "N":
                    obj_infrastructureExpansionApplication.WetLandArea = NOCAP.BLL.Infrastructure.New.Common.InfrastructureNewApplicationB.WetLandAreaYesNo.No;
                    break;
                case "":
                    obj_infrastructureExpansionApplication.WetLandArea = NOCAP.BLL.Infrastructure.New.Common.InfrastructureNewApplicationB.WetLandAreaYesNo.NotDefine;
                    break;
                default:
                    obj_infrastructureExpansionApplication.WetLandArea = NOCAP.BLL.Infrastructure.New.Common.InfrastructureNewApplicationB.WetLandAreaYesNo.NotDefine;
                    break;
            ...
            { obj_infrastructureExpansionApplication.ProposedLocation.ProposedLatitude = null; }
            else
            { obj_infrastructureExpansionApplication.ProposedLocation.ProposedLatitude = Convert.ToDecimal(txtProLat.Text); }
            if (txtProLong.Text.Trim() == "")
            { obj_infrastructureExpansionApplication.ProposedLocation.ProposedLongitude = null; }
            else
            { obj_infrastructureExpansionApplication.ProposedLocation.ProposedLongitude = Convert.ToDecimal(txtProLong.Text); }

            switch (rbtnWhetherGroundWaterUtilization.SelectedValue)
            {
                case "NewIndustry":
                    obj_infrastructureExpansionApplication.GroundWaterUtilizationFor = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.NewProject;
                    obj_infrastructureExpansionApplication.DateOfCommencement = null;
                    obj_infrastructureExpansionApplication.DateOfExpansionOfProject = null;
                    obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.NotDefined;
                    break;
                case "ExistingIndustry":
                    //obj_infrastructureExpansionApplication.GroundWaterUtilizationFor = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.ExistingIndustry;
                    //obj_infrastructureExpansionApplication.DateOfCommencement = Convert.ToDateTime(txtDateOfCommencement.Text);
                    //obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.NotDefined;
                    //break;
                    obj_infrastructureExpansionApplication.GroundWaterUtilizationFor = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.ExistingIndustry;
                    switch (ddlNOCObtainedForExistIND.SelectedValue)
                    {
                        case "Y":
                            obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.Yes;
                            obj_infrastructureExpansionApplication.DateOfCommencement = null;
                            obj_infrastructureExpansionApplication.DateOfExpansionOfProject = null;
                            break;
                        case "N":
                            obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.No;
                            obj_infrastructureExpansionApplication.DateOfCommencement = Convert.ToDateTime(txtDateOfCommencement.Text);
                            obj_infrastructureExpansionApplication.DateOfExpansionOfProject = null;
                            break;
                        default:
                    ...
                    break;
                case "ExpansionProgramExistingIndustry":
                    obj_infrastructureExpansionApplication.GroundWaterUtilizationFor = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.ExpansionProgramme;
                    switch (ddlNOCObtainedForExistIND.SelectedValue)
                    {
                        case "Y":
                            obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.Yes;
                        ...
                        case "N":
                            obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.No;
                            obj_infrastructureExpansionApplication.DateOfCommencement = Convert.ToDateTime(txtDateOfCommencement.Text);
                            obj_infrastructureExpansionApplication.DateOfExpansionOfProject = Convert.ToDateTime(txtDateOfExpansion.Text);
                            break;
                        default:
                            obj_infrastructureExpansionApplication.NOCObtainForExistIndustry.NOCObtainForExistIND = NOCAP.BLL.Common.NOCObtainForExistIndustry.NOCObtainForExistINDOption.NotDefined;
                            obj_infrastructureExpansionApplication.DateOfCommencement = null;
                    ...
                    break;
                default:
                    obj_infrastructureExpansionApplication.GroundWaterUtilizationFor = NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.NotDefined;
                    break;
            }



            NOCAP.BLL.Master.SubDistrict obj_subDistrict = new NOCAP.BLL.Master.SubDistrict(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode);
            obj_infrastructureExpansionApplication.ApplySubDistrictAreaCategoryKey = obj_subDistrict.GetSubDistrictAreaTypeCategoryHistory().SubDistrictAreaTypeCategoryKey;
    ...
    private int AddGeneralInformationLocationDetails()
    {
        try
        {
            ...
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication obj_infrastructureExpansionApplication = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication();
            obj_infrastructureExpansionApplication.ApplicationTypeCode = NOCAPExternalUtility.EquivalentApplicationTypeCodeOfDatabaseForApplicationType("Infrastructure");
            obj_infrastructureExpansionApplication.ApplicationPurposeCode = NOCAPExternalUtility.EquivalentApplicationPurposeCodeOfDatabaseForApplicationPurpose("New");
            obj_infrastructureExpansionApplication.ApplicationTypeCategoryCode = Convert.ToInt32(ddlApplicationTypeCategory.SelectedValue);
            //obj_infrastructureExpansionApplication.InfrastructurNewWaterRequirementRecycledUsesDetail.GroundWaterRequirement = Convert.ToDecimal(txtGroundWaterRequirement.Text);
            ...
            NOCAP.BLL.UserManagement.ExternalUser obj_externalUser = new NOCAP.BLL.UserManagement.ExternalUser(Convert.ToInt32(Session["ExternalUserCode"]));
            obj_infrastructureExpansionApplication.CreatedByExUC = obj_externalUser.ExternalUserCode;
            //string s = obj_infrastructureExpansionApplication.GroundWaterAvailability;
            if (obj_infrastructureExpansionApplication.Add() == 1)
            {
                strStatus = "Added Successfully";
                lblInfrastructureApplicationCodeFrom.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.ApplicationCode);
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                hidCSRF.Value = Convert.ToString(System.Guid.NewGuid());
                ViewState["CSRF"] = hidCSRF.Value;
                if (lblInfrastructureApplicationCodeFrom.Text.Trim() != "") { Server.Transfer("~/ExternalUser/Expansion/INF/CommunicationAddress.aspx"); }
                else { }
            }
        }
    }
    ...
    private void BindGeneralInformationLocationDetails(long lngA_ApplicationCode, Object sender, EventArgs e)
    {
        ...
        {
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication obj_infrastructureExpansionApplication = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication(lngA_ApplicationCode);
            //txtGroundWaterRequirement.Text = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.InfrastructurNewWaterRequirementRecycledUsesDetail.GroundWaterRequirement));
            txtNameOfInfraStructure.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.NameOfInfrastructure);
            txtAddressLine1.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.AddressLine1);
            txtAddressLine2.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.AddressLine2);
            txtAddressLine3.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.AddressLine3);

            ddlWaterQualityType.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.WaterQualityCode));
            ddlApplicationTypeCategory.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.ApplicationTypeCategoryCode));
            ddlState.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode));
            NOCAPExternalUtility.FillDropDownDistrict(ref ddlDistrict, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode);
            ddlDistrict.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode));
            NOCAPExternalUtility.FillDropDownSubDistrict(ref ddlSubDistrict, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode);
            ddlSubDistrict.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode));


            switch (obj_infrastructureExpansionApplication.MSME)
            {
                case NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.MSMEYesNo.Yes:
                    ddlMSME.SelectedValue = "Y";
                    break;
                case NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.MSMEYesNo.No:
            ...
            ddMSMEType.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.MSMETypeCode));
            ...
            if (NOCAPExternalUtility.FillDropDownVillage(ref ddlVillage, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode) != 1)
            {
                lblMessage.Text = "Problem in Village population";
                lblMessage.ForeColor = System.Drawing.Color.Red;
            }

            if (NOCAPExternalUtility.FillDropDownTown(ref ddlTown, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.StateCode) != 1)
            {
                lblMessage.Text = "Problem in Town population";
                lblMessage.ForeColor = System.Drawing.Color.Red;
            }

            switch (obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown)
            {
                case NOCAP.BLL.Common.Address.VillageOrTownOption.Town:
                    ddlTownOrVillage.SelectedValue = "T";
                    ddlTown.Visible = true;
                    ddlTown.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.TownCode));
                ...
                case NOCAP.BLL.Common.Address.VillageOrTownOption.Village:
                    ...
                    ddlVillage.SelectedValue = HttpUtility.HtmlEncode(Convert.ToString(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLocationAddress.VillageCode));
            ...
            txtProLat.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLatitude);
            txtProLong.Text = HttpUtility.HtmlEncode(obj_infrastructureExpansionApplication.ProposedLocation.ProposedLongitude);

            switch (obj_infrastructureExpansionApplication.GroundWaterUtilizationFor)
            {
                case NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.NewProject:
                    rbtnWhetherGroundWaterUtilization.SelectedValue = "NewIndustry";
                    break;
                case NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.ExistingIndustry:
                    rbtnWhetherGroundWaterUtilization.SelectedValue = "ExistingIndustry";
                    break;
                case NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication.GroundWaterUtilizationForOption.ExpansionProgramme:
            ...
            //{
            //    if (!Convert.IsDBNull(obj_infrastructureExpansionApplication.DateOfCommencement))
            //    {
            //        txtDateOfCommencement.Text = HttpUtility.HtmlEncode(Convert.ToDateTime(obj_infrastructureExpansionApplication.DateOfCommencement).ToString("dd/MM/yyyy"));
            //    }
            //}
            //else
            if (rbtnWhetherGroundWaterUtilization.SelectedValue == "ExistingIndustry" || rbtnWhetherGroundWaterUtilization.SelectedValue == "ExpansionProgramExistingIndustry")
            {
                ...
                {
                    if (!String.IsNullOrEmpty(Convert.ToString((obj_infrastructureExpansionApplication.DateOfCommencement))))
                    {
                        txtDateOfCommencement.Text = HttpUtility.HtmlEncode(Convert.ToDateTime(obj_infrastructureExpansionApplication.DateOfCommencement).ToString("dd/MM/yyyy"));
                    }
                    if (rbtnWhetherGroundWaterUtilization.SelectedValue == "ExpansionProgramExistingIndustry")
                    {
                        if (!String.IsNullOrEmpty(Convert.ToString(obj_infrastructureExpansionApplication.DateOfExpansionOfProject)))
                        {
                            txtDateOfExpansion.Text = HttpUtility.HtmlEncode(Convert.ToDateTime(obj_infrastructureExpansionApplication.DateOfExpansionOfProject).ToString("dd/MM/yyyy"));
                        }
                    }
                }
            }
            switch(obj_infrastructureExpansionApplication.WetLandArea)
            {
