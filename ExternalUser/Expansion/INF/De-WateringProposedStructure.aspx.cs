...
public partial class ExternalUser_Expansion_INF_De_WateringProposedStructure : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (lblInfrastructureApplicationCodeFrom.Text.Trim() != "") { BindIGVInfNewProposedDGWASDetails(Convert.ToInt64(lblInfrastructureApplicationCodeFrom.Text)); }
    ...
    {
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication obj_infrastructureNewApplication = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication(lngA_ApplicationCode);
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure obj_infNewProposedDGWASBlank = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure();
        List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure> lst_infNewProposedDGWASBlank = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure>();
        List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure> lst_infNewProposedDGWAS = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure>();
        try
        {
            if (obj_infrastructureNewApplication.InfrastructureDewatering.DewateringRequired == NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationDewatering.deWateringRequired.No) { DisableEnableForm(false); }
            ...
            //}
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure[] arr_infNewProposedDGWAS;
            arr_infNewProposedDGWAS = obj_infrastructureNewApplication.GetInfrastructureNewProposedDeWateringAbstractionStructureList();
            foreach (NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure test in arr_infNewProposedDGWAS) { lst_infNewProposedDGWAS.Add(test); }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure obj_infNewProposedDGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure();
                List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure> lst_infNewProposedDGWASNewList = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure>();
                ...
                {
                    obj_infNewProposedDGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure();
    ...
    {
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure obj_infNewProposedDGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure();
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    obj_infNewProposedDGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure(Convert.ToInt64(gvdeWateringPrposed.DataKeys[e.Row.RowIndex].Values[0].ToString()), Convert.ToInt32(lbl_SerialNumber.Text));
    ...
    protected void btnPrev_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                hidCSRF.Value = Convert.ToString(System.Guid.NewGuid());
                Session["CSRF"] = hidCSRF.Value;
                Server.Transfer("~/ExternalUser/Expansion/INF/De-WateringExistingStructure.aspx");
            }
        }
    }
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                if (UpdateInfNewProposedDGWASDetails(Convert.ToInt64(lblInfrastructureApplicationCodeFrom.Text)) == 1)
                {
                    ...
                    Server.Transfer("~/ExternalUser/Expansion/INF/ExistingGroundwaterAbstractionStructure.aspx");
                }
                else
                {
                }
    ...
    private int UpdateInfNewProposedDGWASDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            if (obj_infrastructureNewApplication.InfrastructureDewatering.DewateringRequired == NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationDewatering.deWateringRequired.Yes)
            {
            ...
            List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure> lst_infNewProposedDGWASList = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure>();
            foreach (GridViewRow gvRow in gvdeWateringPrposed.Rows)
            {
                Label lbl_TypeOfAbstractionStructureCode = (Label)gvRow.FindControl("TypeOfAbstractionStructureCode");
                Label lbl_YearOfConstruction = (Label)gvRow.FindControl("YearOfConstruction");
            ...
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure[] arr_tempInfDeWateringProposedListBLL = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplicationProposedDeWateringAbstractionStructure[lst_infNewProposedDGWASList.Count];
            lst_infNewProposedDGWASList.CopyTo(arr_tempInfDeWateringProposedListBLL);
            obj_infrastructureNewApplication.InfrastructureExpansionProposedDeWateringAbstractionStructureList = arr_tempInfDeWateringProposedListBLL;
