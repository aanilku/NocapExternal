...
public partial class ExternalUser_Expansion_INF_ExistingGroundwaterAbstractionStructure : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (lblInfrastructureApplicationCodeFrom.Text.Trim() != "") { BindIGVInfNewExistingGWASDetails(Convert.ToInt64(lblInfrastructureApplicationCodeFrom.Text)); }
            }
            catch (Exception)
            {
    ...
    private void BindIGVInfNewExistingGWASDetails(long lngA_ApplicationCode)
    {
        ...
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure obj_infNewExistingGWASBlank = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure();
        List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure> lst_infNewExistingGWASBlank = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure>();
        List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure> lst_infNewExistingGWAS = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure>();
        try
        {
            ...
            //}
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure[] arr_infNewExistingGWAS;
            arr_infNewExistingGWAS = obj_infrastructureNewApplication.GetInfrastructureExpansionExistingGroundWaterAbstractionStructureList();
            foreach (NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure test in arr_infNewExistingGWAS) { lst_infNewExistingGWAS.Add(test); }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure obj_infNewExistingGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure();
                List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure> lst_infNewExistingGWASNewList = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure>();
                ...
                {
                    obj_infNewExistingGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure();
                    obj_infNewExistingGWASBlankForGridToObj.InfrastructureNewApplicationCode = Convert.ToInt64(gvGASExisting.DataKeys[gvRow.RowIndex].Value.ToString());
                ...
                //---------------
                obj_infNewExistingGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure();
                obj_infNewExistingGWASBlankForGridToObj.InfrastructureNewApplicationCode = Convert.ToInt64(lblInfrastructureApplicationCodeFrom.Text);
    ...
    {
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure obj_infNewExistingGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure();
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    obj_infNewExistingGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure(Convert.ToInt64(gvGASExisting.DataKeys[e.Row.RowIndex].Values[0].ToString()), Convert.ToInt32(lbl_SerialNumber.Text));
    ...
    protected void btnPrev_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                Server.Transfer("~/ExternalUser/Expansion/INF/De-WateringProposedStructure.aspx");
            }
        }
    }
    ...
    private int UpdateInfNewExistingGWASDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication obj_infrastructureNewApplication = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication(lngA_ApplicationCode);
            List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure> lst_infNewExistingGWASList = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure>();
            //if (gvGASExisting.Rows.Count != Convert.ToInt32(txtNumbeOfExistingGAS.Text))
            //{
            ...
            foreach (GridViewRow gvRow in gvGASExisting.Rows)
            {
                ...
                Label lbl_WhetherPermissionRegisteredWithCGWADetails = (Label)gvRow.FindControl("WhetherPermissionRegisteredWithCGWADetails");
                NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure obj_infNewExistingGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure();
                obj_infNewExistingGWAS.InfrastructureNewApplicationCode = Convert.ToInt32(gvGASExisting.DataKeys[gvRow.RowIndex].Value.ToString());
            ...
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure[] arr_tempInfGwasExistingListBLL = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionExistingGroundWaterAbstractionStructure[lst_infNewExistingGWASList.Count];
            lst_infNewExistingGWASList.CopyTo(arr_tempInfGwasExistingListBLL);
            obj_infrastructureNewApplication.InfrastructureExpansionExistingGroundWaterAbstractionStructureList = arr_tempInfGwasExistingListBLL;
            if (txtNumbeOfExistingGAS.Text.Trim() == "")
            {
