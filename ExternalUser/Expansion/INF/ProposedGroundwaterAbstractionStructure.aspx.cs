...
public partial class ExternalUser_Expansion_INF_ProposedGroundwaterAbstractionStructure : System.Web.UI.Page
{
    ...
    private void BindIGVInfNewProposedGWASDetails(long lngA_ApplicationCode)
    {
        ...
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure obj_infNewProposedGWASBlank = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure();
        List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure> lst_infNewProposedGWASBlank = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure>();
        List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure> lst_infNewProposedGWAS = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure>();
        ...
        try
        {
            ...
            //}
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure[] arr_infNewProposedGWAS;
            arr_infNewProposedGWAS = obj_infrastructureNewApplication.GetInfrastructureExpansionProposedGroundWaterAbstractionStructureList();
            foreach (NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure test in arr_infNewProposedGWAS)
            {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure obj_infNewProposedGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure();
                List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure> lst_infNewProposedGWASNewList = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure>();
                ...
                {
                    obj_infNewProposedGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure();
                    obj_infNewProposedGWASBlankForGridToObj.InfrastructureNewApplicationCode = Convert.ToInt64(gvGASProposed.DataKeys[gvRow.RowIndex].Value.ToString());
                ...
                //---------------
                obj_infNewProposedGWASBlankForGridToObj = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure();
                obj_infNewProposedGWASBlankForGridToObj.InfrastructureNewApplicationCode = Convert.ToInt64(lblInfrastructureApplicationCodeFrom.Text);
    ...
    {
        NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure obj_infNewProposedGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure();
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    obj_infNewProposedGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure(Convert.ToInt64(gvGASProposed.DataKeys[e.Row.RowIndex].Values[0].ToString()), Convert.ToInt32(lbl_SerialNumber.Text));
    ...
    private int UpdateInfNewProposedGWASDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication obj_infrastructureNewApplication = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionApplication(lngA_ApplicationCode);
            List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure> lst_infNewProposedGWASList = new List<NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure>();
            //if (gvGASProposed.Rows.Count != Convert.ToInt32(txtNumbeOfProposedGAS.Text))
            //{
            ...
            foreach (GridViewRow gvRow in gvGASProposed.Rows)
            {
                ...
                NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure obj_infNewProposedGWAS = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure();
                obj_infNewProposedGWAS.InfrastructureNewApplicationCode = Convert.ToInt32(gvGASProposed.DataKeys[gvRow.RowIndex].Value.ToString());
            ...
            NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure[] arr_tempInfGwasProposedListBLL = new NOCAP.BLL.Infrastructure.Expansion.InfrastructureExpansionProposedGroundWaterAbstractionStructure[lst_infNewProposedGWASList.Count];
            lst_infNewProposedGWASList.CopyTo(arr_tempInfGwasProposedListBLL);
            obj_infrastructureNewApplication.InfrastructureExpansionProposedGroundWaterAbstractionStructureList = arr_tempInfGwasProposedListBLL;
            if (txtNumbeOfProposedGAS.Text.Trim() == "")
            {
