<%@ Page Title="NOCAP-Industrial Application Expansion" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="SelfDeclaration.aspx.cs" Inherits="ExternalUser_Expansion_IND_SelfDeclaration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <%--  <link type="text/css" href="../../Styles/jquery-ui-1.8.19.custom.css" rel="stylesheet" />
    <script type="text/javascript" src="../../Scripts/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="../../Scripts/jquery-ui-1.8.19.custom.min.js"></script>
    <script type="text/javascript">
        $(function () {
            $(document.getElementById('<%= txtBharatKoshDated.ClientID %>')).datepicker({
    ...
    <script type="text/javascript">
        function validate() {
            ...
            var inputText = document.getElementById("<%=txtBharatKoshDated.ClientID %>");

            if (inputText.value != "") {

                // Match the date format through regular expression
                if (inputText.value.match(dateformat)) {
                    document.getElementById("<%=txtBharatKoshDated.ClientID %>").focus();
                    ...
                    if (mm == 1 || mm > 2) {
                        if (dd > ListofDays[mm - 1]) {
                            ...
                            document.getElementById("<%=txtBharatKoshDated.ClientID %>").focusout();
                        }
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                INDUSTRIAL EXPANSION USE- Self Declaration
                            </div>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="[0-9]*"
                                            ErrorMessage="Only Numeric values are allowed" ValidationGroup="SelfDeclaration"
                                            Display="Dynamic" ForeColor="Red" ControlToValidate="txtBharatKoshRefferenceNo"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBharatKoshDated" runat="server" MaxLength="10"></asp:TextBox>
                                        <%-- onblur="return validate()"></asp:TextBox>--%>
                    ...
                    <%--<tr>--%>
                       ...
                       <%-- <td colspan="2">--%>
                           <%-- It is to certify that no case related to ground water withdrawal/ contamination
                            ...
                            I here by declare that all the mandatory documents prescribed in the application form are uploaded and no blank /irrelevant documents have been uploaded. I am also aware that any false and wrong submission /uploading of document will lead to rejection of my application.--%>
                   ...
                   <%-- <tr>
                        ...
                        <td colspan="2">
                            Application proforma is subject to modification from time to time.&nbsp; delete</td>
                    </tr>
                    <tr>
                        <td>
                            2.
                        ...
                        <td colspan="2">
                            ...
                            <br />
                            <strong>Regional Director, Central Ground Water Board delete</strong><br />
                            <b>
                                <asp:Label ID="lblRegionalOffi" runat="server"></asp:Label>&nbsp;delete</b></td>
                    </tr>
                    <tr>
                        <td>
                            3.
             ...
             <tr>
                        <td colspan="3" class="Coumpulsory">
                            <asp:Label CssClass="Coumpulsory" ID="lblSubmittedApplication" runat="server" Text="c)  
                               Scanned copy of signature and seal document should be attached at presribed place before submission of application.
                                ...
                                "></asp:Label>
                            <%--<br />
                            <asp:Label Text="Last page of application can be obtain from Preview option in New-Save As Draft." runat="server" ></asp:Label>--%>
                        </td>
                    </tr>
                    <tr runat="server" id="RowCharges">
                        <td colspan="3" class="Coumpulsory">
                               <asp:Label ID="Label2" runat="server" Text="d)" CssClass="Coumpulsory"></asp:Label>
                            <%--<asp:Label CssClass="Coumpulsory" ID="lblCharges" runat="server" ></asp:Label>--%>      
                                </td>                          
                    ...
                    <%--     <tr>
                        <td></td>
                        <td>
                            <strong>Submitted Application will not be Processed till it the Print Out of the 
                            Signed
                                Complete Application is Submitted to Regional Office. 
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lblFee" runat="server" Text=""></asp:Label> </td>
                    </tr>
                    <tr>
                       
                        <td colspan="2">
                        <b>
                        Note: - The Processing Fee is Non-Refundable. Applicant should ensure and Check Eligibility of 
                            Submission of Application and Required Documents before Submitting Online Application.</b></td>
                    </tr>--%>
                    <tr>
                        <td colspan="3">
                    ...
                    <tr>
                        <td style="text-align: center" colspan="3">
                            ...
                            <asp:Button ID="txtNext" runat="server" Text="Next >>" ValidationGroup="SelfDeclaration"
                                OnClick="txtNext_Click" OnClientClick="return ConfirmApproval();" />
                            <asp:Button ID="btnSubmit" runat="server" Text="TestSubmit" Visible="False" />
                        </td>
                    </tr>
                </table>
            </td>
