...
public partial class ExternalUser_Expansion_IND_INDExpansionReadyToSubmit : System.Web.UI.Page
{
    ...
    protected void btnReadyToSubmitSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                {
                    if (obj_industrialNewApplication.ReadyToSubmitApplication(null, obj_externalUser.ExternalUserCode) == 1)
                    {
