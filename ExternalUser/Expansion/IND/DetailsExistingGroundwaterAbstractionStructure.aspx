<%@ Page Title="NOCAP-Industrial Application Expansion" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="DetailsExistingGroundwaterAbstractionStructure.aspx.cs" Inherits="ExternalUser_Expansion_IND_DetailsExistingGroundwaterAbstractionStructure"
    Theme="Skin" %>
            ...
            <td>
                <div>
                    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                        <tr>
                            <td colspan="2">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    INDUSTRIAL EXPANSION USE: 3. Groundwater Abstraction Structure- Existing
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <b>3 (a). Groundwater Abstraction Structure- Existing (<span class="Coumpulsory">$</span>)</b>
                            </td>
                        </tr>
