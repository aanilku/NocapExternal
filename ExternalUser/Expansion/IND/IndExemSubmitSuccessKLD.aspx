<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true" CodeFile="IndExemSubmitSuccessKLD.aspx.cs" Inherits="ExternalUser_Expansion_IND_IndExemSubmitSuccessKLD" %>

<%@ PreviousPageType VirtualPath="SalientFeatureKLD.aspx" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                INDUSTRIAL EXPANSION USE : EXEMPTION
                            </div>
                        </td>
                    </tr>
                    <tr>
