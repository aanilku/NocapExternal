<%@ Page Title="NOCAP-Industrial Application Expansion" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="IndustrialExpansion.aspx.cs" Inherits="ExternalUser_Expansion_IND_IndustrialExpansion" %>
            ...
            <td>               
                    ...
                    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNameOfIndustry" runat="server" MaxLength="100" Width="99%" Enabled="false"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddMSMEType" Width="200px" runat="server" Enabled="false">
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center">
                                ...
                                <asp:Button ID="btnSaveAsDraft" runat="server" Text="Save as Draft" OnClick="btnSaveAsDraft_Click"
                                    ValidationGroup="LocationDetails" Enabled="false" />
