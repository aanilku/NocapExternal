...
public partial class ExternalUser_Expansion_IND_Attachment : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (lblIndustialApplicationCodeFrom.Text.Trim() != "")
                {
                    ...
                    BindImpactReportOCSAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                   ...
                   // BindBharatKoshRecieptAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text)); //anil
                    BindAbstRestChargeAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                    BindRestChargeAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));

                   // BindSignedDocAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text)); // anil
                    BindExtraAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                    BindPenaltyAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
    ...
    private void BindPenaltyAttachment(long lngA_ApplicationCode)
    {
        try
        {
            decimal decTotalGroundWaterRequirement = 0;
            ...
            lblPenalty.Text = HttpUtility.HtmlEncode("Penalty Attachment (" + AttCount.ToString() + ")");


            #region Penalty Attachment
    ...
    private void BindBharatKoshRecieptAttachment(long lngA_ApplicationCode)
    {
        try
        {
            decimal decTotalGroundWaterRequirement = 0;
    ...
    private void BindGridView(GridView gv, long lngA_ApplicationCode, ref decimal decTotalGroundWaterRequirement, ref int AttCount)
    {
        ...
        if (gv.ID == "gvAffidavitNonAva")
            ...
            arr_industrialNewApplicationAttachmentList = obj_industrialNewApplication.GetNonPollutingEffluentAttachmentList(); //.GetNonPollutingAttachmentList();
    ...
    private void BindAbstRestChargeAttachment(long lngA_ApplicationCode)
    {
        try
        {
            ...
            //arr_industrialNewApplicationAttachmentList = obj_industrialNewApplication.GetAbsRestChargeAttachmentList();
            //gvAbstRestCharge.DataSource = arr_industrialNewApplicationAttachmentList;
            //gvAbstRestCharge.DataBind();


            decimal decTotalGroundWaterRequirement = 0;
            int AttCount = 0;
            BindGridView(gvAbstRestCharge, lngA_ApplicationCode, ref decTotalGroundWaterRequirement, ref AttCount);
            lblAbstRestCharge.Text = HttpUtility.HtmlEncode("Bharatkosh reciept/Copy of Demand Draft (Abstraction Charges) (" + AttCount.ToString() + ")");

            int int_areatypecat = AreaTypeCatCode(lngA_ApplicationCode);
            if (int_areatypecat == 2 || int_areatypecat == 3 || int_areatypecat == 4)
            {
                if ((decTotalGroundWaterRequirement > GroundWaterRequirement0KLD && decTotalGroundWaterRequirement <= GroundWaterRequirement10KLD))
                    lblAbstRestCharge2.Visible = false;
                else if ((decTotalGroundWaterRequirement > GroundWaterRequirement10KLD && decTotalGroundWaterRequirement <= GroundWaterRequirement100KLD))
                    lblAbstRestCharge2.Visible = false;
                else if (decTotalGroundWaterRequirement > GroundWaterRequirement100KLD)
                    lblAbstRestCharge2.Visible = false;
    ...
    private void BindRestChargeAttachment(long lngA_ApplicationCode)
    {
        try
        {
            ...
            decimal decTotalGroundWaterRequirement = 0;
            int AttCount = 0;
            BindGridView(gvRestCharge, lngA_ApplicationCode, ref decTotalGroundWaterRequirement, ref AttCount);
            lblRestCharge.Text = HttpUtility.HtmlEncode("Bharatkosh reciept/Copy of Demand Draft (Restoration Charges) (" + AttCount.ToString() + ")");

            int int_areatypecat = AreaTypeCatCode(lngA_ApplicationCode);
            if (int_areatypecat == 5)
            {
                if ((decTotalGroundWaterRequirement > GroundWaterRequirement0KLD && decTotalGroundWaterRequirement <= GroundWaterRequirement10KLD))
                    lblRestCharge2.Visible = false;
                else if ((decTotalGroundWaterRequirement > GroundWaterRequirement10KLD && decTotalGroundWaterRequirement <= GroundWaterRequirement100KLD))
                    lblRestCharge2.Visible = false;
                else if (decTotalGroundWaterRequirement > GroundWaterRequirement100KLD)
                    lblRestCharge2.Visible = false;
    ...
    private void BindImpactReportOCSAttachment(long lngA_ApplicationCode)
    {
        try
        {
            ...
            decimal decTotalGroundWaterRequirement = 0;
            int AttCount = 0;
            BindGridView(gvImpactReportOCS, lngA_ApplicationCode, ref decTotalGroundWaterRequirement, ref AttCount);
            lblImpactReportOCS.Text = HttpUtility.HtmlEncode("Impact AssementReport for OCS areas by accredited consultants (" + AttCount.ToString() + ")");

            int aretypecode = AreaTypeCatCode(lngA_ApplicationCode);
            if (aretypecode == 3 || aretypecode == 4 || aretypecode == 5)
            //if (aretypecode == 2 || aretypecode == 3 || aretypecode == 4 || aretypecode == 5)
            {
               
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewSADApplication = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(lngA_ApplicationCode);
                if (obj_industrialNewSADApplication.WaterQuality != NOCAP.BLL.Common.CommonEnum.WaterQualityOption.RannKuchch)
                {
                    if ((decTotalGroundWaterRequirement > GroundWaterRequirement0KLD && decTotalGroundWaterRequirement <= GroundWaterRequirement10KLD))
                    {
                        lblImpactReportOCS2.Visible = false;
                    ...
                    {
                        lblImpactReportOCS2.Visible = true;
                        rowIAR.Visible = true;
                    }
                }
                else
    ...
    private int AttachmentsCountReferalLetter()
    {
        ...
        for (int i = 1; i < ddlReferralLetter.Items.Count; i++)
        {
            ...
            Count = Count + obj_industrialNewApplication.GetCpoyOfReferralLetterAttachmentList(obj_industrialNewReferralLetter.ReferralLetterAttachCode, NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment.SortingFieldForAttachment.NoSorting).Length;
        }
    ...
    protected void btnUploadPenalty_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                hidCSRF.Value = Convert.ToString(System.Guid.NewGuid());
                Session["CSRF"] = hidCSRF.Value;
                strActionName = "File Upload Penalty";
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewApplicationForNoLimit = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment[] arr_industrialNewApplicationAttachmentList;
                arr_industrialNewApplicationAttachmentList = obj_industrialNewApplicationForNoLimit.GetPenaltyAttachmentList();
                ...
                if (arr_industrialNewApplicationAttachmentList.Count() < AttachmentNumberLimit())
                {
                    ...
                    try
                    {
                        if (FileUploadPenalty.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                if (NOCAPExternalUtility.IsValidFile(FileUploadPenalty.PostedFile))
                                {
                                    ...
                                    {
                                        obj_insertIndustrialNewApplicationAttachment.AttachmentFile = NOCAPExternalUtility.StreamFile(FileUploadPenalty.PostedFile);
                                        obj_insertIndustrialNewApplicationAttachment.ContentType = FileUploadPenalty.PostedFile.ContentType;
                                        obj_insertIndustrialNewApplicationAttachment.AttachmentPath = FileUploadPenalty.FileName;
                                        obj_insertIndustrialNewApplicationAttachment.FileExtension = str_ext;
                                    }
                                    else
                                    {
                        ...
                        obj_insertIndustrialNewApplicationAttachment.IndustrialNewApplicationCode = obj_industrialNewApplication.IndustrialNewApplicationCode;
                        obj_insertIndustrialNewApplicationAttachment.AttachmentCode = obj_industrialNewApplication.PenaltyAttCode;
                        obj_insertIndustrialNewApplicationAttachment.AttachmentName = txtPenalty.Text; ;
                        NOCAP.BLL.UserManagement.ExternalUser obj_externalUser = new NOCAP.BLL.UserManagement.ExternalUser(Convert.ToInt32(Session["ExternalUserCode"]));
                        obj_insertIndustrialNewApplicationAttachment.CreatedByExUC = obj_externalUser.ExternalUserCode;
                        if (obj_insertIndustrialNewApplicationAttachment.Add() == 1)
                        {
                        ...
                        BindPenaltyAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                        clearMessage();
                        lblMessagePenalty.Text = obj_insertIndustrialNewApplicationAttachment.CustumMessage;
                    }
                    catch (Exception)
                    {
                        Response.Redirect("~/ExternalErrorPage.aspx", false);
                    ...
                    try
                    {
                        if (FileUploadConsent.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                ...
                                {
                                    if (FileUploadConsent.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    {
                        arr_industrialNewApplicationAttachmentList = obj_industrialNewApplicationForNoLimit.GetCpoyOfReferralLetterAttachmentList(obj_industrialNewReferralLetterk.ReferralLetterAttachCode, NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment.SortingFieldForAttachment.NoSorting);
                    ...
                    if (int_CountAttForRefLetter < AttachmentNumberLimit())
                    {
                        ...
                        try
                        {
                            ...
                            NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment obj_insertIndustrialNewApplicationAttachmentAferAdd = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment();
                            NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewApplicationAfterAdd = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                            List<NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment> lst_industrialNewApplicationAttachmentList = new List<NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment>();
                            byte[] buffer = new byte[1];
    ...
    protected void btnNonPolluting_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewApplicationForNoLimit = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment[] arr_industrialNewApplicationAttachmentList;
                arr_industrialNewApplicationAttachmentList = obj_industrialNewApplicationForNoLimit.GetNonPollutingEffluentAttachmentList();    //.GetNonPollutingAttachmentList();
                        ...
                        if (FileUploadNonPolluting.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                if (NOCAPExternalUtility.IsValidFile(FileUploadNonPolluting.PostedFile))
                                {
                                    ...
                                    if (FileUploadNonPolluting.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
                    ...
                    try
                    {
                        if (FileUploadSigneddoc.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                ...
                                {
                                    if (FileUploadSigneddoc.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
    ...
    protected void btnUploadBharatKoshReciept_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                //            lblMessageBharatKoshReciept.ForeColor = System.Drawing.Color.Red;
                //        }
                //        BindBharatKoshRecieptAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                //        clearMessage();
                    ...
                    try
                    {
                        if (FileUploadMSME.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                ...
                                {
                                    if (FileUploadMSME.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
    ...
    protected void btnUploadAbstRestCharge_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            if (Convert.ToString(Session["CSRF"]) != hidCSRF.Value)
            ...
            else
            {
                ...
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewApplicationForNoLimit = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment[] arr_industrialNewApplicationAttachmentList;
                arr_industrialNewApplicationAttachmentList = obj_industrialNewApplicationForNoLimit.GetAbsRestChargeAttachmentList();
                ...
                if (arr_industrialNewApplicationAttachmentList.Count() < AttachmentNumberLimit())
                {
                    ...
                    try
                    {
                        if (FileUploadAbstRestCharge.HasFile)
                        {
                            str_ext = System.IO.Path.GetExtension(FileUploadAbstRestCharge.PostedFile.FileName).ToLower();
                            str_fname = FileUploadAbstRestCharge.FileName;
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                if (NOCAPExternalUtility.IsValidFile(FileUploadAbstRestCharge.PostedFile))
                                {
                                    if (FileUploadAbstRestCharge.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
                                        obj_insertIndustrialNewApplicationAttachment.AttachmentFile = NOCAPExternalUtility.StreamFile(FileUploadAbstRestCharge.PostedFile);
                                        obj_insertIndustrialNewApplicationAttachment.ContentType = FileUploadAbstRestCharge.PostedFile.ContentType;
                                        obj_insertIndustrialNewApplicationAttachment.AttachmentPath = FileUploadAbstRestCharge.FileName;
                                        obj_insertIndustrialNewApplicationAttachment.FileExtension = str_ext;
                                    }
                                    else
                                    {
                                        strStatus = "File Upload Failed";
                                        lblMessageAbstRestCharge.Text = "File can not upload. It has more than 5 MB size";
                                        lblMessageAbstRestCharge.ForeColor = System.Drawing.Color.Red;
                                        return;
                                    }
                                }
                                else
                                {
                                    strStatus = "File Upload Failed";
                                    lblMessageAbstRestCharge.Text = "Not a valid file!!..Select an other file!!";
                                    lblMessageAbstRestCharge.ForeColor = System.Drawing.Color.Red;
                                    return;
                                }
                            }
                        ...
                        {
                            lblMessageAbstRestCharge.Text = "Please select a file..!!";
                            lblMessageAbstRestCharge.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        obj_insertIndustrialNewApplicationAttachment.IndustrialNewApplicationCode = obj_industrialNewApplication.IndustrialNewApplicationCode;
                        obj_insertIndustrialNewApplicationAttachment.AttachmentCode = obj_industrialNewApplication.AbsRestChargeAttCode;
                        obj_insertIndustrialNewApplicationAttachment.AttachmentName = txtAbstRestCharge.Text;
                        NOCAP.BLL.UserManagement.ExternalUser obj_externalUser = new NOCAP.BLL.UserManagement.ExternalUser(Convert.ToInt32(Session["ExternalUserCode"]));
                        obj_insertIndustrialNewApplicationAttachment.CreatedByExUC = obj_externalUser.ExternalUserCode;
                        if (obj_insertIndustrialNewApplicationAttachment.Add() == 1)
                        {
                            strStatus = "File Upload Success";
                            obj_insertIndustrialNewApplicationAttachment.AttachmentPath = str_newFileNameWithPath;
                            lblMessageAbstRestCharge.ForeColor = Color.Green;
                        ...
                        BindAbstRestChargeAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                        clearMessage();
                        lblMessageAbstRestCharge.Text = obj_insertIndustrialNewApplicationAttachment.CustumMessage;
                    }
                    catch (Exception)
                    {
                        Response.Redirect("~/ExternalErrorPage.aspx", false);
    ...
    protected void btnUploadRestCharge_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            if (Convert.ToString(Session["CSRF"]) != hidCSRF.Value)
            ...
            else
            {
                ...
                hidCSRF.Value = Convert.ToString(System.Guid.NewGuid());
                Session["CSRF"] = hidCSRF.Value;
                strActionName = "File Restoration Charges";
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewApplicationForNoLimit = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment[] arr_industrialNewApplicationAttachmentList;
                arr_industrialNewApplicationAttachmentList = obj_industrialNewApplicationForNoLimit.GetRestChargeAttachmentList();
                ...
                if (arr_industrialNewApplicationAttachmentList.Count() < AttachmentNumberLimit())
                {
                    ...
                    try
                    {
                        if (FileUploadRestCharge.HasFile)
                        {
                            str_ext = System.IO.Path.GetExtension(FileUploadRestCharge.PostedFile.FileName).ToLower();
                            str_fname = FileUploadRestCharge.FileName;
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                if (NOCAPExternalUtility.IsValidFile(FileUploadRestCharge.PostedFile))
                                {
                                    if (FileUploadRestCharge.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
                                        obj_insertIndustrialNewApplicationAttachment.AttachmentFile = NOCAPExternalUtility.StreamFile(FileUploadRestCharge.PostedFile);
                                        obj_insertIndustrialNewApplicationAttachment.ContentType = FileUploadRestCharge.PostedFile.ContentType;
                                        obj_insertIndustrialNewApplicationAttachment.AttachmentPath = FileUploadRestCharge.FileName;
                                        obj_insertIndustrialNewApplicationAttachment.FileExtension = str_ext;
                                    }
                                    else
                                    {
                                        strStatus = "File Upload Failed";
                                        lblMessageRestCharge.Text = "File can not upload. It has more than 5 MB size";
                                        lblMessageRestCharge.ForeColor = System.Drawing.Color.Red;
                                        return;
                                    }
                                }
                                else
                                {
                                    strStatus = "File Upload Failed";
                                    lblMessageRestCharge.Text = "Not a valid file!!..Select an other file!!";
                                    lblMessageRestCharge.ForeColor = System.Drawing.Color.Red;
                                    return;
                                }
                            }
                        ...
                        {
                            lblMessageRestCharge.Text = "Please select a file..!!";
                            lblMessageRestCharge.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        obj_insertIndustrialNewApplicationAttachment.IndustrialNewApplicationCode = obj_industrialNewApplication.IndustrialNewApplicationCode;
                        obj_insertIndustrialNewApplicationAttachment.AttachmentCode = obj_industrialNewApplication.RestChargeAttCode;
                        obj_insertIndustrialNewApplicationAttachment.AttachmentName = txtRestCharge.Text;
                        NOCAP.BLL.UserManagement.ExternalUser obj_externalUser = new NOCAP.BLL.UserManagement.ExternalUser(Convert.ToInt32(Session["ExternalUserCode"]));
                        obj_insertIndustrialNewApplicationAttachment.CreatedByExUC = obj_externalUser.ExternalUserCode;
                        if (obj_insertIndustrialNewApplicationAttachment.Add() == 1)
                        {
                            strStatus = "File Upload Success";
                            obj_insertIndustrialNewApplicationAttachment.AttachmentPath = str_newFileNameWithPath;
                            lblMessageRestCharge.ForeColor = Color.Green;
                        }
                        else
                        {
                            strStatus = "File Upload Failed";
                        ...
                        BindRestChargeAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                        clearMessage();
                        lblMessageRestCharge.Text = obj_insertIndustrialNewApplicationAttachment.CustumMessage;
                    }
                    catch (Exception)
                    {
                        Response.Redirect("~/ExternalErrorPage.aspx", false);
                    ...
                    try
                    {
                        if (FileUploadAffidavitNonAva.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                ...
                                {
                                    if (FileUploadAffidavitNonAva.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
    ...
    protected void btnUplodImpactReportOCS_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            if (Convert.ToString(Session["CSRF"]) != hidCSRF.Value)
            ...
            else
            {
                ...
                hidCSRF.Value = Convert.ToString(System.Guid.NewGuid());
                Session["CSRF"] = hidCSRF.Value;
                strActionName = "File Impact Report OCS";
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewApplicationForNoLimit = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt64(lblIndustialApplicationCodeFrom.Text));
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment[] arr_industrialNewApplicationAttachmentList;
                arr_industrialNewApplicationAttachmentList = obj_industrialNewApplicationForNoLimit.GetImpactAssOCSAttachmentList();

                if (obj_industrialNewApplicationForNoLimit.ImpactAssOCSOTPVerified == NOCAP.BLL.Industrial.New.Common.IndustrialNewApplicationB.ImpactAssOCSOTPVerifiedYesNo.Yes)
                {
                    if (arr_industrialNewApplicationAttachmentList.Count() < AttachmentNumberLimit())
                    {
                        string str_fname;
                        ...
                        try
                        {
                            if (FileUploadImpactReportOCS.HasFile)
                            {
                                str_ext = System.IO.Path.GetExtension(FileUploadImpactReportOCS.PostedFile.FileName).ToLower();
                                str_fname = FileUploadImpactReportOCS.FileName;
                                if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                                {
                                    if (NOCAPExternalUtility.IsValidFile(FileUploadImpactReportOCS.PostedFile))
                                    {
                                        if (FileUploadImpactReportOCS.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                        {
                                            obj_insertIndustrialNewApplicationAttachment.AttachmentFile = NOCAPExternalUtility.StreamFile(FileUploadImpactReportOCS.PostedFile);
                                            obj_insertIndustrialNewApplicationAttachment.ContentType = FileUploadImpactReportOCS.PostedFile.ContentType;
                                            obj_insertIndustrialNewApplicationAttachment.AttachmentPath = FileUploadImpactReportOCS.FileName;
                                            obj_insertIndustrialNewApplicationAttachment.FileExtension = str_ext;
                                        }
                                        else
                                        {
                                            strStatus = "File Upload Failed";
                                            lblMessageImpactReportOCS.Text = "File can not upload. It has more than 5 MB size";
                                            lblMessageImpactReportOCS.ForeColor = System.Drawing.Color.Red;
                                            return;
                                        }
                                    }
                                    else
                                    {
                                        strStatus = "File Upload Failed";
                                        lblMessageImpactReportOCS.Text = "Not a valid file!!..Select an other file!!";
                                        lblMessageImpactReportOCS.ForeColor = System.Drawing.Color.Red;
                                        return;
                                    }
                                }
                            ...
                            {
                                lblMessageImpactReportOCS.Text = "Please select a file..!!";
                                lblMessageImpactReportOCS.ForeColor = System.Drawing.Color.Red;
                                return;
                            }
                            obj_insertIndustrialNewApplicationAttachment.IndustrialNewApplicationCode = obj_industrialNewApplication.IndustrialNewApplicationCode;
                            obj_insertIndustrialNewApplicationAttachment.AttachmentCode = obj_industrialNewApplication.ImpactAssOCSAttCode;
                            obj_insertIndustrialNewApplicationAttachment.AttachmentName = txtImpactReportOCS.Text;
                            ...
                            if (obj_insertIndustrialNewApplicationAttachment.Add() == 1)
                            {
                                strStatus = "File Upload Success";
                                obj_insertIndustrialNewApplicationAttachment.AttachmentPath = str_newFileNameWithPath;
                                lblMessageImpactReportOCS.ForeColor = Color.Green;
                            ...
                            BindImpactReportOCSAttachment(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
                            clearMessage();
                            lblMessageImpactReportOCS.Text = obj_insertIndustrialNewApplicationAttachment.CustumMessage;
                        }
                        catch (Exception)
                        {
                            Response.Redirect("~/ExternalErrorPage.aspx", false);
                    ...
                    {
                        lblMessageImpactReportOCS.Text = "Maximum number of files to be uploaded is 5";
                        lblMessageImpactReportOCS.ForeColor = System.Drawing.Color.Red;
                    }
                }
                else
                {
                    lblMessageImpactReportOCS.Text = "Please Verified Consultant OTP";
                    lblMessageImpactReportOCS.ForeColor = System.Drawing.Color.Red;
                }
                    ...
                    try
                    {
                        if (FileUploadAffidavitOtherThanMSME.HasFile)
                        {
                            ...
                            if (str_ext == ".txt" || str_ext == ".doc" || str_ext == ".docx" || str_ext == ".jpg" || str_ext == ".jpeg" || str_ext == ".pdf")
                            {
                                ...
                                {
                                    if (FileUploadAffidavitOtherThanMSME.PostedFile.ContentLength < NOCAPExternalUtility.ExternalAttachmentSizeLimit())
                                    {
    ...
    protected void gvReferralLetterAttachment_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                arr_industrialNewApplicationAttachmentList = obj_industrialNewApplication.GetCpoyOfReferralLetterAttachmentList(int_AttachmentCode, NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplicationAttachment.SortingFieldForAttachment.NoSorting);
    ...
    protected void gvAbstRestCharge_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        if (Convert.ToString(Session["CSRF"]) != hidCSRF.Value)
        {
            Response.Redirect(NOCAPExternalUtility.ExternalErrorRedirectUrl, false);
        ...
        else
        {
            ...
            try
            {
                strActionName = "File Delete Abstration charges";
                if (DeleteAttchment((GridView)sender, e, lblMessageAbstRestCharge, strActionName) == 1)
    ...
    protected void gvRestCharge_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        if (Convert.ToString(Session["CSRF"]) != hidCSRF.Value)
        {
            Response.Redirect(NOCAPExternalUtility.ExternalErrorRedirectUrl, false);
        ...
        else
        {
            ...
            try
            {
                strActionName = "File Delete Restoration charges";
                if (DeleteAttchment((GridView)sender, e, lblMessageRestCharge, strActionName) == 1)
    ...
    protected void gvImpactReportOCS_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        if (Convert.ToString(Session["CSRF"]) != hidCSRF.Value)
        {
            Response.Redirect(NOCAPExternalUtility.ExternalErrorRedirectUrl, false);
        ...
        else
        {
            ...
            try
            {
                strActionName = "File Delete ImpactReport";
                if (DeleteAttchment((GridView)sender, e, lblMessageImpactReportOCS, strActionName) == 1)
        ...
        else
        {
            try
            {
                ...
                if (e.CommandArgument != null)
                {
                    ...
                    NOCAPExternalUtility.INDExpansionAppDownloadFiles(lng_industrialNewApplicationCode, int_attachmentCode, int_attachmentCodeSerialNumber);
                }
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        if (obj_industrialNewApplication.GetNonPollutingEffluentAttachmentList().Length < 1) { ErrorMessage = ErrorMessage == string.Empty ? "Ground Water Quality Report" : ErrorMessage + ",Ground Water Quality Report"; }
                        //GetNonPollutingAttachmentList Anil Change
                    }
                    ...
                    if (lblImpactReportOCS2.Visible)
                    {
                        if (obj_industrialNewApplication.GetImpactAssOCSAttachmentList().Length < 1) { ErrorMessage = ErrorMessage == string.Empty ? "Impact AssementReport for OCS areas by accredited consultants" : ErrorMessage + ",Impact AssementReport for OCS areas by accredited consultants"; }
                    }
                    ...
                    Server.Transfer("INDExpansionReadyToSubmit.aspx");
                    //Server.Transfer("INDNewOnlinePayment.aspx");
                    //Server.Transfer("~/ExternalUser/Payment.aspx");
    ...
    protected void btnOTPVerify_Click(object sender, EventArgs e)
    {
        ...
        {
            IndustrialNewSADApplication obj_industrialNewSADApplication = new IndustrialNewSADApplication(Convert.ToUInt32(lblApplicationCode.Text));
            if (obj_industrialNewSADApplication.IndustrialNewApplicationCode > 0)
            {
                obj_industrialNewSADApplication.ImpactAssOCSOTPVerified = NOCAP.BLL.Industrial.New.Common.IndustrialNewApplicationB.ImpactAssOCSOTPVerifiedYesNo.Yes;
                obj_industrialNewSADApplication.ImpactAssOCSOTPVerifiedByCC = Convert.ToInt32(ddlConsultant.SelectedValue);
                obj_industrialNewSADApplication.ModifiedByExUC = Convert.ToInt64(Session["ExternalUserCode"]); ;
                int int_result = 1;// obj_industrialNewSADApplication.SetImpactAssOCSOTPVerified();
                if (int_result == 1)
                {
                    ddlConsultant.SelectedIndex = -1;
                    txtImpactReportOCSOTP.Text = "";
                    lblMessageImpactReportOCS.Text = "OTP Verifired successfully.";
                    lblMessageImpactReportOCS.ForeColor = Color.Green;
                    OTPVerifyEnavleDesable();
                ...
                {
                    lblMessageImpactReportOCS.Text = "OTP Verification failed.";
                    lblMessageImpactReportOCS.ForeColor = Color.Red;
            ...
            {
                lblMessageImpactReportOCS.Text = "Error on page.";
                lblMessageImpactReportOCS.ForeColor = Color.Red;
                tableIAR.Visible = false;
                return;
            }
        ...
        {
            lblMessageImpactReportOCS.Text = "Invalid OTP, Please try again";
            lblMessageImpactReportOCS.ForeColor = Color.Red;
            tableIAR.Visible = false;
            return;
        }
    ...
    protected void btnSendOTP_Click(object sender, EventArgs e)
    {
        ...
        if (ddlConsultant.SelectedIndex > 0)
        {
            ...
            if (obj_ConsultantDetail != null && obj_ConsultantDetail.ConsultantCode > 0)
            {
                ...
                NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication obj_industrialNewSADApplication = new NOCAP.BLL.Industrial.Expansion.IndustrialExpansionApplication(Convert.ToInt64(lblApplicationCode.Text));
                if (obj_industrialNewSADApplication.IndustrialNewApplicationCode > 0)
                {

                    if (SMSUtility.IsSendSMSEnable())
                    {
                        OTPMessage = "Do not share OTP with anyone. OTP for submission of IAR / CHR to CGWA in respect of your application name : " + obj_industrialNewSADApplication.NameOfIndustry + " is :" + OTP;
                    ...
                    if (EmailUtility.IsSendEmailEnable())
                    {
                        ...
                        string str_StateName = new NOCAP.BLL.Master.State(obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.StateCode).StateName;
                        string str_DistrictName = new NOCAP.BLL.Master.District(obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.DistrictCode).DistrictName;
                        string str_SubDistrictName = new NOCAP.BLL.Master.SubDistrict(obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode).SubDistrictName;

                        if (obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown == NOCAP.BLL.Common.Address.VillageOrTownOption.Town)
                        {
                            str_TownName = "Town Name : ";
                            str_TownName = str_TownName + new NOCAP.BLL.Master.Town(obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.TownCode).TownName;
                            str_TownName = str_TownName + ", ";
                        }
                        if (obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.VillageOrTown == NOCAP.BLL.Common.Address.VillageOrTownOption.Village)
                        {
                            str_VillageName = "Village Name : ";
                            str_VillageName = str_VillageName + new NOCAP.BLL.Master.Village(obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.StateCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.DistrictCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.SubDistrictCode, obj_industrialNewSADApplication.ProposedLocation.ProposedLocationAddress.VillageCode).VillageName;
