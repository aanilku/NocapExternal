<%@ Page Title="NOCAP-Industrial Application Expansion" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="DetailsProposedGroundwaterAbstractionStructure.aspx.cs" Inherits="ExternalUser_Expansion_IND_DetailsProposedGroundwaterAbstractionStructure"
    Theme="Skin" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    INDUSTRIAL EXPANSION USE: 3. Groundwater Abstraction Structure- Proposed
                                </div>
                            </td>
                        </tr>
                        <tr>
