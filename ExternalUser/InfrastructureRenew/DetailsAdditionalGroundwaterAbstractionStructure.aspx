<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="DetailsAdditionalGroundwaterAbstractionStructure.aspx.cs"
    Inherits="ExternalUser_InfrastructureRenew_DetailsAdditionalGroundwaterAbstractionStructure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" class="SubFormWOBG" width="100%">
                                ...
                                <div class="block_left_inner">
                                    <div id="information" class="cont_left" style="display: block">
                                        <ul class="progressbar">
                                            ...
                                            <li class="active">Groundwater Abstraction Structure- Additional</li>
            ...
            <td>
                <div>
                    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                        <tr>
                            <td colspan="2">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    RENEW - INFRASTRUCTURE USE: 3. Groundwater Abstraction Structure- Additional
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <b>3 (b). Groundwater Abstraction Structure- Additional </b>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 35%">
                                Number of Additional Structures: <span class="Coumpulsory">*</span>
                            </td>
                            <td>
                                <asp:TextBox ID="txtNumbeOfAdditionalGAS" runat="server" MaxLength="3" Width="200px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="txtNumbeOfAdditionalGAS"
                                    Display="Dynamic" ErrorMessage="Required" ForeColor="Red" ValidationGroup="RecycledWaterUsage"></asp:RequiredFieldValidator><br />
                                <asp:RegularExpressionValidator ID="revtxtNumbeOfAdditionalGAS" runat="server" ForeColor="Red"
                                    Display="Dynamic" ControlToValidate="txtNumbeOfAdditionalGAS" ValidationGroup="RecycledWaterUsage"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                    </table>
                    <fieldset>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RangeValidator ID="RngValYearOfConstruction" runat="server" ControlToValidate="txtYearOfConstruction"
                                        ...
                                        ValidationGroup="GASAdditional"></asp:RangeValidator>
                                    <asp:RegularExpressionValidator ID="revtxtYearOfConstruction" runat="server" Display="Dynamic"
                                        ForeColor="Red" ControlToValidate="txtYearOfConstruction" ValidationGroup="GASAdditional"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvGASAdditional" runat="server" AutoGenerateColumns="false" CssClass="SubFormWOBG"
                    Caption="<th colspan='15'><b>Detail of Structures</b></th>" DataKeyNames="InfrastructureRenewApplicationCode"
                    ShowHeaderWhenEmpty="true" OnRowDataBound="gvGASAdditional_RowDataBound" OnRowCommand="gvGASAdditional_RowCommand">
                    <Columns>
                    ...
                    <EmptyDataTemplate>
                        No Records exist in Groundwater Abstraction Structure- Additional.
                    </EmptyDataTemplate>
                </asp:GridView>
            </td>
        </tr>
