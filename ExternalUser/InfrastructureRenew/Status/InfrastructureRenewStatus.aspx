<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true" CodeFile="InfrastructureRenewStatus.aspx.cs" Inherits="ExternalUser_InfrastructureRenew_Status_InfrastructureRenewStatus" %>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                            ...
                                            <asp:GridView ID="grdVerificationInfrastructureApplicationStatus" runat="server" ShowHeaderWhenEmpty="true"
                                            ...
                                            <br />
                                            <asp:GridView ID="grdAppProcessingInfrastructureApplicationStatus" runat="server" Width="100%"
                                                OnRowCommand="grdAppProcessingInfrastructureApplicationStatus_RowCommand" AutoGenerateColumns="false"
                                                ...
                                                OnRowDataBound="grdAppProcessingInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdNOCProcessingInfrastructureApplicationStatus" runat="server" Width="100%"
                                                ...
                                                OnRowDataBound="grdNOCProcessingInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
                                            ...
                                            <asp:GridView ID="grdDisbursmentProcessingInfrastructureApplicationStatus" runat="server"
                                                ...
                                                OnRowDataBound="grdDisbursmentProcessingInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
