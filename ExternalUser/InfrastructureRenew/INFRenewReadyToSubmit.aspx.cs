...
public partial class ExternalUser_InfrastructureRenew_INFRenewReadyToSubmit : System.Web.UI.Page
{
    string strActionName = "ReadyToSubmit", strStatus = "", strPageName = "INFRenewReadyToSubmit";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            try
            {
                ...
                BindReport(lblInfrastructureApplicationCodeFrom.Text);
    ...
    private void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Infrastructure/Renew/PrintApplication/InfrastructureRenewSADApplication";
    ...
    protected void btnReadyToSubmitSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                {
                    if (obj_infrastructureRenewApplication.ReadyToSubmitApplication(out lng_submittedApplicationCode, null, obj_externalUser.ExternalUserCode) == 1)
                    {
