<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_InfrastructureRenew_SelfDeclaration" %>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INFRASTRUCTURE USE- Self Declaration
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <table class="SubFormWOBG" style="line-height: 25px" width="100%">
                                <tr>
                                    <td colspan="3">Processing Fee:&nbsp; <span class="Coumpulsory">* </span>(<span class="Coumpulsory">$</span>)
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    <td></td>
                                    <td>Bharat Kosh Transaction Date:
                                    </td>
                                    <td>
                    ...
                    <%--<tr>
                        ...
                        <td>
                            Bharat Kosh Transaction Ref. No:<span class="Coumpulsory">*</span>
                        </td>
                        <td>
                            <asp:TextBox ID="txtBharatKoshRefferenceNo" runat="server" MaxLength="19"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="revtxtBharatKoshRefferenceNo" runat="server"
                    ...
                    <tr>
                        ...
                        <td>
                            Bharat Kosh Transaction Dated:<span class="Coumpulsory">*</span>
                        </td>
                        <td>
                            <asp:TextBox ID="txtBharatKoshDated" runat="server"></asp:TextBox>
                            <asp:CalendarExtender ID="txtBharatKoshDatedCalendarExtender" runat="server" Enabled="True"
                    ...
                    <tr>
                        ...
                        <td colspan="2">Application proforma is subject to modification from time to time.
                        </td>
                    </tr>
                    <tr>
                        <td>2.
                        </td>
                        <td colspan="2">Application will be submitted online on website http://cgwa-noc.gov.in to following office.<br />
                            <br />
                    ...
                    <tr>
                        ...
                        <td colspan="2">Incomplete application will be summarily rejected.
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
