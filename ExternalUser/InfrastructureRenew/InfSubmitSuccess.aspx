<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="InfSubmitSuccess.aspx.cs"
    Inherits="ExternalUser_InfrastructureRenew_InfSubmitSuccess" %>
                    ...
                    <tr>
                        <td>
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INFRASTRUCTURE USE: SUCCESSFUL SUBMISSION
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="margin-left: 50px; text-align: right">
                            <asp:LinkButton ID="lbtnPrint" runat="server" PostBackUrl="~/ExternalUser/InfrastructureRenew/Reports/INFRenewReportViewer.aspx"
