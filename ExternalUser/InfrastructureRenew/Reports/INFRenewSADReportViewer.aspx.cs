...
public partial class ExternalUser_InfrastructureRenew_Reports_INFRenewSADReportViewer : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            if (PreviousPage != null)
            {
                try
                {
                    ...
                    if (placeHolder != null)
                    {
                        Label lblApplicationRenewCode = (Label)placeHolder.FindControl("lblApplicationCode");
    ...
    void BindReport(string ApplicationRenewCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Infrastructure/Renew/PrintApplication/InfrastructureRenewSADApplicationforExternal";
