...
public partial class ExternalUser_InfrastructureRenew_Reports_INFRenewReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationRenewCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Infrastructure/Renew/PrintApplication/InfrastructureRenewUseApplicationforExternal";
