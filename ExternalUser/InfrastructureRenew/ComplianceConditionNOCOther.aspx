<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_InfrastructureRenew_ComplianceConditionNOCOther" %>
        ...
        <tr>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td>
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INFRASTRUCTURE USE: 4. Compliance to the Conditions prescribed in the NOC
                                - Other
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <center>
                                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <b>b). Compliance to the Conditions prescribed in the NOC - Other</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top">
                    ...
                    <tr align="center">
                        <td>
                            <%--   <asp:GridView ID="gvCompCondNOCOther" runat="server" CssClass="SubFormWOBG" AllowPaging="true"
                    AutoGenerateColumns="False"  align="center" DataKeyNames="IndustrialRenewApplicationCode,ComplianceConditionNOCSerialNumber"
                    Width="520px" PageSize="5"   >
                    <Columns>
                        
                        <asp:TemplateField HeaderText="S.No." SortExpression="ComplianceConditionCode">
                        ...
                        <asp:TemplateField HeaderText="Condition give in NOC" SortExpression="ComplianceConditionDescription">                            
                            <ItemTemplate>
                            
                                <asp:Label ID="lblCompConOtherDesc" runat="server" Text='<%#System.Web.HttpUtility.HtmlEncode(Eval("ComplianceConditionEnter"))%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                        PageButtonCount="4" />
                            ...
                            <asp:GridView ID="gvCompCondNOCOther" runat="server"  CssClass="SubFormWOBG"
                                AutoGenerateColumns="False" align="center" DataKeyNames="InfrastructureRenewApplicationCode,ComplianceConditionNOCSerialNumber"
