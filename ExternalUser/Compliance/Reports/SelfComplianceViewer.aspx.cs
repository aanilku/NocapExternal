...
public partial class ExternalUser_Compliance_Reports_SelfComplianceViewer : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (PreviousPage != null)
            {
                ...
                if (placeHolder != null)
                {
                    ...
                    Label SourceLabel2 = (Label)placeHolder.FindControl("lblApplicationCodeFrom");
                    if (SourceLabel2 != null)
                    {
                        lblApplicationCodeFrom.Text = HttpUtility.HtmlEncode(SourceLabel2.Text);
                    ...
                    if (lblApplicationCodeFrom.Text.Trim() != "")
                    {
                        try
                        {
                            ...
                            BindTelemetryDetailGrid(gvTelemetry, Convert.ToInt64(lblApplicationCodeFrom.Text));
                           ...
                           //obj_TelemetryUserLoginDetail1.ApplicationCode =Convert.ToInt64(lblApplicationCodeFrom.Text);
   ...
   private  void BindTelemetryDetailGrid(GridView gv,long AppCode)
    {
        NOCAP.BLL.Misc.Telemetry.TelemetryUserLoginDetail obj_TelemetryUserLoginDetail1 = new NOCAP.BLL.Misc.Telemetry.TelemetryUserLoginDetail();
        obj_TelemetryUserLoginDetail1.ApplicationCode = AppCode;
        gv.DataSource = obj_TelemetryUserLoginDetail1.GetTelemetryUserLoginDetailList();
        gv.DataBind();
