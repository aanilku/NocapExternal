...
public partial class ExternalUser_Compliance_Reports_SelfComplianceReportViewer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    try
        //    {
        //        if (Session["ApplicationCodeForSelfCompliance"] != null)
        //        {
        //            ViewState["ApplicationCodeForSelfCompliance"] = Session["ApplicationCodeForSelfCompliance"];
        //            BindReport(Convert.ToString(ViewState["ApplicationCodeForSelfCompliance"]));
        //            Session["ApplicationCodeForSelfCompliance"] = null;
        //        }
        //    }
        //    catch (Exception)
        //    {
            ...
            if (PreviousPage != null)
            {
                try
                {
                    ...
                    if (placeHolder != null)
                    {
                        ...
                        if (lblApplicationCode != null && lblApplicationCode.Text != "")
                        {
                            BindReport(lblApplicationCode.Text);
                        }
                        lblApplicationCode = (Label)placeHolder.FindControl("lblApplicationRenewCode");
                        if (lblApplicationCode != null && lblApplicationCode.Text != "")
                        {
                            BindReport(lblApplicationCode.Text);
                        }
    ...
    void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Reports/Compliance/SelfCompliance";
            param[0] = new ReportParameter("bintAppCode", ApplicationCode);
