<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" 
   MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="SelfComplianceA.aspx.cs" Inherits="ExternalUser_Compliance_SelfComplianceA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" class="SubFormWOBG" width="100%" style="line-height: 20px">
                ...
                <table width="100%" class="SubFormWOBG" align="left">
                    ...
                    <tr>
                        ...
                        <td>(ii) Dewatering:<br />
                            ...
                            <%--<asp:RequiredFieldValidator runat="server" ForeColor="Red"
                                Display="Dynamic" ControlToValidate="txtQtyDewateringPerDay" ValidationGroup="SelfCompliance"
                                ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
                    ...
                    <tr>
                        ...
                        <td>(ii) Dewatering:<br />
                            ...
                            <%--<asp:RequiredFieldValidator runat="server" ForeColor="Red"
                                Display="Dynamic" ControlToValidate="txtQtyDewateringPerYear" ValidationGroup="SelfCompliance"
                                ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
        ...
        <%--  <tr>
            ...
            <td colspan="3">
                <asp:Label runat="server" Text="Applicant / Project Address " Font-Bold="true"></asp:Label>
            </td>

        </tr>
        <tr>
            <td></td>
            <td>(a) Address of Unit
            </td>
            <td colspan="2">
                <table width="100%" class="SubFormWOBG" align="left">
                    <tr>
                        <td style="width: 20%">Address Line 1:
                        </td>
                        <td style="width: 80%">
                            <asp:Label ID="lblAddressLine1" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%">Address Line 2:
                        </td>
                        <td style="width: 80%">
                            <asp:Label ID="lblAddressLine2" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%">Address Line 3:
                        </td>
                        <td style="width: 80%">
                            <asp:Label ID="lblAddressLine3" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:Label ID="lblState" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:Label ID="lblDistrict" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%">Sub-District:
                        </td>
                        <td style="width: 80%">
                            <asp:Label ID="lblSubDistrict" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%">Village/Town:
                        </td>
                        <td style="width: 80%">
                            <asp:Label ID="lblVillageTown" runat="server">Label</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td></td>
            <td>(b) Category of Block -OE/Critical/Semi-Critical/Safe
            </td>
            <td colspan="2">
                <asp:Label ID="lblCateOfBlock" runat="server"></asp:Label>
            </td>
        </tr>--%>
        <tr>
            <td colspan="6">
