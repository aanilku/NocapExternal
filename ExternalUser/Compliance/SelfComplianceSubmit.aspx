<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"  MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="SelfComplianceSubmit.aspx.cs" Inherits="ExternalUser_Compliance_SelfComplianceSubmit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
        ...
        <tr>
            ...
            <td>No. of observation well/key well in core and buffer zone (in case of Mining project):</td>
            <td>
                <asp:TextBox runat="server" ID="txtNoOversWell" Enabled="false"></asp:TextBox>
