<%@ Page Title="NOCAP-Infrastructure Application-New" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="InfrastructureNew.aspx.cs"
    Inherits="ExternalUser_InfrastructureNew_InfrastructureNew" %>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="5">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                INFRASTRUCTURE USE: 1. General Information- Location Details
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNameOfInfraStructure" runat="server" MaxLength="100" Width="99%"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTownOrVillage" runat="server" Width="200px" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlTownOrVillage_SelectedIndexChanged">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtProLat" runat="server" Width="99%"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtProLong" runat="server" Width="99%"></asp:TextBox>
                    ...
                    <tr runat="server" id="RowDateOfCommencement" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtDateOfCommencement" Width="85%"  runat="server"></asp:TextBox><%--Width="200px"--%>
                    ...
                    <tr runat="server" id="RowDateOfExpansion" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtDateOfExpansion" Width="85%" runat="server"></asp:TextBox><%--Width="200px"--%>
