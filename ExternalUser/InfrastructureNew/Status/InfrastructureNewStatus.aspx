<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="InfrastructureNewStatus.aspx.cs"
    Inherits="ExternalUser_InfrastructureNew_Status_InfrastructureNewStatus" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="width: 100%; height: 23px; line-height: 22px;
                                padding-left: 10px">
                                <asp:Label ID="Label1" runat="server" ForeColor="White" Font-Bold="True" Text="Application Status"></asp:Label>
                            </div>
                        </td>
                    </tr>
            ...
            <td colspan="2">
                <table width="100%" class="SubFormWOBG">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblECReceived" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                            ...
                                            <asp:GridView ID="grdVerificationInfrastructureApplicationStatus" runat="server"
                                                PageSize="8" AllowPaging="true" Width="100%" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                CssClass='SubFormWOBG"' Caption='<center><div class="SubmittedApp"><b>Application Verification</b></div></center>'
                                                DataKeyNames="ApplicationCode,SerialNumber" OnRowDataBound="grdVerificationInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdAppProcessingInfrastructureApplicationStatus" runat="server"
                                                Width="100%" OnRowCommand="grdAppProcessingInfrastructureApplicationStatus_RowCommand"
                                                Caption='<center><div class="SubmittedApp"><b>Application Processing</b></div></center>'
                                                AutoGenerateColumns="false" CssClass="SubFormWOBG" DataKeyNames="ApplicationCode,SerialNumber"
                                                ShowHeaderWhenEmpty="true" OnRowDataBound="grdAppProcessingInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdNOCProcessingInfrastructureApplicationStatus" runat="server"
                                                Width="100%" Caption='<center><div class="SubmittedApp"><b>NOC Processing</b></div></center>'
                                                AutoGenerateColumns="false" CssClass="SubFormWOBG" DataKeyNames="ApplicationCode,SerialNumber"
                                                ShowHeaderWhenEmpty="true" OnRowDataBound="grdNOCProcessingInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdDisbursmentProcessingInfrastructureApplicationStatus" runat="server"
                                                Width="100%" Caption='<center><div class="SubmittedApp"><b>NOC Disbursement</b></div></center>'
                                                AutoGenerateColumns="false" CssClass="SubFormWOBG" ShowHeaderWhenEmpty="true"
                                                DataKeyNames="ApplicationCode,SerialNumber" OnRowDataBound="grdDisbursmentProcessingInfrastructureApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
