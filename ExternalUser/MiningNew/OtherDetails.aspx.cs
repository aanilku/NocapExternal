...
public partial class ExternalUser_Mining_OtherDetails : System.Web.UI.Page
{
    ...
    //    {
    //        NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication obj_MiningNewApplication = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication(lngA_ApplicationCode);
    //        NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter obj_MiningNewReferralLetterBlank = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter();
    //        List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter> lst_MiningNewReferralLetterList = new List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter>();
    //        NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter[] arr_MiningNewReferralLetterList;
    ...
    private int UpdateOtherDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication obj_MiningstructureNewApplication = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication(lngA_ApplicationCode);
    ...
    protected void gvMINRefLetter_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter obj_MiningNewReferralLetter = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADReferralLetter(Convert.ToInt64(lblMiningApplicationCodeFrom.Text), Convert.ToInt32(lbl_ReferralLetterTypeCode.Text));
