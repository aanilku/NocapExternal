<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="MiningNewStatus.aspx.cs"
    Inherits="ExternalUser_MiningNew_Status_MiningNewStatus" %>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                            ...
                                            <asp:GridView ID="grdVerificationMiningApplicationStatus" runat="server" PageSize="8"
                                                AllowPaging="true" Width="100%" AutoGenerateColumns="false" CssClass="SubFormWOBG"
                                                Caption='<center><div class="SubmittedApp"><b>Application Verification</b></div></center>'
                                                DataKeyNames="ApplicationCode,SerialNumber" ShowHeaderWhenEmpty="true" OnRowDataBound="grdVerificationMiningApplicationStatus_RowDataBound">
                                                <Columns>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdAppProcessingMiningApplicationStatus" runat="server" Width="100%"
                                                OnRowCommand="grdAppProcessingMiningApplicationStatus_RowCommand" AutoGenerateColumns="false"
                                                ...
                                                OnRowDataBound="grdAppProcessingMiningApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdNOCProcessingMiningApplicationStatus" runat="server" Width="100%"
                                                ...
                                                OnRowDataBound="grdNOCProcessingMiningApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
                                            ...
                                            <br />
                                            <asp:GridView ID="grdDisbursmentProcessingMiningApplicationStatus" runat="server"
                                                Width="100%" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" CssClass="SubFormWOBG"
                                                DataKeyNames="ApplicationCode,SerialNumber" Caption='<center><div class="SubmittedApp"><b>NOC Disbursement</b></div></center>'
                                                OnRowDataBound="grdDisbursmentProcessingMiningApplicationStatus_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Receive Date" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <%#System.Web.HttpUtility.HtmlEncode(Eval("ReceiveDate", "{0:d}"))%>
