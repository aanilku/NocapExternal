...
public partial class ExternalUser_Mining_DetailsExistingGroundwaterAbstractionStructure : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (lblModeFrom.Text.Trim() == "Edit") { BindIGVMinNewExistingGWASDetails(Convert.ToInt64(lblMiningApplicationCodeFrom.Text)); }
            }
            catch (Exception)
            {
    ...
    private void BindIGVMinNewExistingGWASDetails(long lngA_ApplicationCode)
    {
        ...
        NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure obj_minNewExistingGWASBlank = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure();
        List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure> lst_minNewExistingGWASBlank = new List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure>();
        List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure> lst_minNewExistingGWAS = new List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure>();
        try
        {
            ...
            NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure[] arr_minNewExistingGWAS;
            arr_minNewExistingGWAS = obj_MiningNewApplication.GetMiningNewExistingGroundWaterAbstractionStructureList();
            foreach (NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure test in arr_minNewExistingGWAS) { lst_minNewExistingGWAS.Add(test); }
    ...
    protected void txtNext_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Page.IsValid)
            {
                ...
                {
                    Server.Transfer("~/ExternalUser/MiningNew/DetailsProposedGroundwaterAbstractionStructure.aspx");
                }
            }
        }
    }
    ...
    private int UpdateMinNewExistingGWASDetails(long lngA_ApplicationCode)
    {
        try
        {
            ...
            NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication obj_MiningNewApplication = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADApplication(lngA_ApplicationCode);
            List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure> lst_minNewExistingGWASList = new List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure>();
            ...
            foreach (GridViewRow gvRow in gvGASExisting.Rows)
            {
                ...
                NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure obj_minNewExistingGWAS = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure();
            ...
            NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure[] arr_tempMinGwasExistingListBLL = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure[lst_minNewExistingGWASList.Count];
            lst_minNewExistingGWASList.CopyTo(arr_tempMinGwasExistingListBLL);
            obj_MiningNewApplication.MiningNewExistingGroundWaterAbstractionStructureList = arr_tempMinGwasExistingListBLL;
            if (txtNumbeOfExistingGAS.Text.Trim() == "")
            {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure obj_MinNewExistingGWASBlankForGridToObj = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure();
                List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure> lst_MinNewExistingGWASNewList = new List<NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure>();
                foreach (GridViewRow gvRow in gvGASExisting.Rows)
                {
                    obj_MinNewExistingGWASBlankForGridToObj = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure();
    ...
    protected void gvGASExisting_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    obj_minNewExistingGWAS = new NOCAP.BLL.Mining.New.SADApplication.MiningNewSADExistingGroundWaterAbstractionStructure(Convert.ToInt64(gvGASExisting.DataKeys[e.Row.RowIndex].Values[0].ToString()), Convert.ToInt32(lbl_SerialNumber.Text));
