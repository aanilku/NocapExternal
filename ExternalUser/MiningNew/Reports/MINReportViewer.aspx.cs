...
public partial class ExternalUser_MiningNew_Reports_MINReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Mining/New/PrintApplication/MiningUseApplicationforExternal";
            //RvResult.ServerReport.ReportPath = "/cgwa-noc/NOCAP/Mining/New/PrintApplication/MiningUseApplication";
