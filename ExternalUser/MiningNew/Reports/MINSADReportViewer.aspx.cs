...
public partial class ExternalUser_MiningNew_Reports_MINSADReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Mining/New/PrintApplication/MiningSADApplicationforExternal";            
