...
public partial class ExternalUser_IndustrialNew_DetailsProposedGroundwaterAbstractionStructure : System.Web.UI.Page
{
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    UpdateIndNewProposedGWASDetails(Convert.ToInt64(lblIndustialApplicationCodeFrom.Text));
    ...
    protected void txtNext_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                hidCSRF.Value = Convert.ToString(System.Guid.NewGuid());
                Session["CSRF"] = hidCSRF.Value;
                if (UpdateIndNewProposedGWASDetails(Convert.ToInt64(lblIndustialApplicationCodeFrom.Text)) == 1)
                {
