...
public partial class ExternalUser_IndustrialNew_WaterRequirementDetails : System.Web.UI.Page
{
            ...
            else
            {
                ...
                if (Status == 1)
                {
                    if (UpdateWaterRequirementDetails(Convert.ToInt64(lblIndustialApplicationCodeFrom.Text)) == 1)
                    {
                        ...
                        str_RedirectPath = "~/ExternalUser/IndustrialNew/RecycledWaterUsage.aspx";
    ...
    private void CheckMSMEWithAreaTypeCat(NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication objA_IndustrialNewSADApplication, decimal dec_IndustrialUse, decimal dec_OtherUse, out int Status)
    {
        Status = 1;
