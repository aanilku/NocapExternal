...
public partial class ExternalUser_IndustrialNew_DetailsExistingGroundwaterAbstractionStructure : System.Web.UI.Page
{
    ...
    protected void btnPrev_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //else
                Server.Transfer("~/ExternalUser/IndustrialNew/RecycledWaterUsage.aspx");
        }
    ...
    protected void txtNext_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                {
                    Server.Transfer("~/ExternalUser/IndustrialNew/DetailsProposedGroundwaterAbstractionStructure.aspx");
                }
            }
        }
    }
