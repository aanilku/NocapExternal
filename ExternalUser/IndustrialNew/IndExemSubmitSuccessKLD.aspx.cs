...
public partial class ExternalUser_IndustrialNew_IndExemSubmitSuccessKLD : System.Web.UI.Page
{
    ...
    private void GetIndustrialApplicationNumber(long lngSubmittedApplicationCode)
    {
        ...
        {
            NOCAP.BLL.Industrial.New.Application.IndustrialNewApplication obj_industrialNewApplication = new NOCAP.BLL.Industrial.New.Application.IndustrialNewApplication(lngSubmittedApplicationCode);
            NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication obj_industrialNewSadApplication = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
