...
public partial class ExternalUser_IndustrialNew_Submit : System.Web.UI.Page
{
            ...
            else
            {
                ...
                switch (obj_industrialNewApplication.MSME)
                {
                    ...
                    case NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication.MSMEYesNo.No:
                        lblMSME.Text = "No";
                        break;
                    case NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication.MSMEYesNo.NotDefine:
                ...
                switch (obj_industrialNewApplication.WetLandArea)
                {
                    ...
                    case NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication.WetLandAreaYesNo.No:
                        ...
                        break;
                    case NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication.WetLandAreaYesNo.NotDefine:
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        obj_industrialNewApplication = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text));
