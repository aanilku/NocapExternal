...
public partial class ExternalUser_IndustrialNew_Reports_INDSADReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Industrial/New/PrintApplication/IndustrialSADApplicationforExternal";
