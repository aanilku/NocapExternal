...
public partial class INDReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationCode)
    {
        ...
        RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Industrial/New/PrintApplication/IndustrialUseApplicationforExternal";
