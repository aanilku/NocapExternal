...
public partial class ExternalUser_Industrial9 : System.Web.UI.Page
{
    ...
    protected void btnUplodImpactReportOCS_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication obj_industrialNewApplicationForNoLimit = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication(Convert.ToInt64(lblIndustialApplicationCodeFrom.Text));
                NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplicationAttachment[] arr_industrialNewApplicationAttachmentList;
        ...
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Server.Transfer("INDNewReadyToSubmit.aspx");
    ...
    protected void btnSendOTP_Click(object sender, EventArgs e)
    {
        ...
        if (ddlConsultant.SelectedIndex > 0)
        {
            ...
            if (obj_ConsultantDetail != null && obj_ConsultantDetail.ConsultantCode > 0)
            {
                ...
                NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication obj_industrialNewSADApplication = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication(Convert.ToInt64(lblApplicationCode.Text));
                if (obj_industrialNewSADApplication.IndustrialNewApplicationCode > 0)
                {
