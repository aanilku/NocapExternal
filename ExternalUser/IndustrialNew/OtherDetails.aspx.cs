...
public partial class ExternalUser_IndustrialNew_OtherDetails : System.Web.UI.Page
{
    ...
    //    {
    //        NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication obj_industrialNewApplication = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADApplication(lngA_ApplicationCode);
    //        //NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter obj_industrialNewReferralLetter = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter(lngA_ApplicationCode, 1);
    //        NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter obj_industrialNewReferralLetterBlank = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter();
    //        List<NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter> lst_industrialNewReferralLetterList = new List<NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter>();
    //        NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter[] arr_IndustrialNewReferralLetterList;
    ...
    protected void gvIndRefLetter_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter obj_industrialNewReferralLetter = new NOCAP.BLL.Industrial.New.SADApplication.IndustrialNewSADReferralLetter(Convert.ToInt64(lblIndustialApplicationCodeFrom.Text), Convert.ToInt32(lbl_ReferralLetterTypeCode.Text));
