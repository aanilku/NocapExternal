...
public partial class ExternalUser_IndustrialNew_RecycledWaterUsage : System.Web.UI.Page
{
            ...
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    if (UpdateRecycledWaterUsageDetails(Convert.ToInt32(lblIndustialApplicationCodeFrom.Text)) == 1)
                    {
                        ...
                        {
                            str_RedirectPath = "~/ExternalUser/IndustrialNew/SalientFeature.aspx";

                        }
                        else
                        {
                            str_RedirectPath = "~/ExternalUser/IndustrialNew/DetailsExistingGroundwaterAbstractionStructure.aspx";
        ...
        finally
        {
            ...
            switch (str_RedirectPath)
            {
                case "~/ExternalUser/IndustrialNew/SalientFeature.aspx":
                    ...
                    break;
                case "~/ExternalUser/IndustrialNew/DetailsExistingGroundwaterAbstractionStructure.aspx":
                    Server.Transfer("~/ExternalUser/IndustrialNew/DetailsExistingGroundwaterAbstractionStructure.aspx");
                    break;
