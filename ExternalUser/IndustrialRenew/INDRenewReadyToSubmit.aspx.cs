...
public partial class ExternalUser_IndustrialRenew_INDRenewReadyToSubmit : System.Web.UI.Page
{
    string strActionName = "ReadyToSubmit", strStatus = "", strPageName = "INDRenewReadyToSubmit";
    ...
    private void BindReport(string ApplicationCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Industrial/Renew/PrintApplication/IndustrialRenewSADApplication";
    ...
    protected void btnReadyToSubmitSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            else
            {
                ...
                {
                    if (obj_industrialRenewApplication.ReadyToSubmitApplication(out lng_submittedApplicationCode, null, obj_externalUser.ExternalUserCode) == 1)
                    {
