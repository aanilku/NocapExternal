<%@ Page Title="NOCAP- Industrial Application for Renewal" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="WaterRequirementDetails.aspx.cs" Inherits="ExternalUser_IndustrialRenew_WaterRequirementDetails" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INDUSTRIAL USE: 2. Water Requirement Details
                            </div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" class="SubFormWOBG" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSurfaceWaterRequirementPro" runat="server" MaxLength="9" Width="97%"
                                            onblur="SumTWR();"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvtxtSurfaceWaterRequirementPro" runat="server"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvtxtProposedExistingWaterSupplyExist" runat="server"
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtProposedExistingWaterSupplyPro" runat="server" MaxLength="9"
                                            onblur="SumTWR();" Width="97%"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvtxtProposedExistingWaterSupplyPro" runat="server"
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" class="SubFormWOBG" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtIndActNoOfOperationalDaysInYear" runat="server" Width="95%" onblur="cal1()"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvtxtResidDomExistRequirement" runat="server" ForeColor="Red"
                                            ...
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtResidDomExist" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtResidDomExistRequirement" ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtResidDomProposedRequirement" runat="server" Width="95%" onblur="cal1()"
                                            MaxLength="9"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvtxtResidDomProposedRequirement" runat="server"
                                            ForeColor="Red" Display="Dynamic" ControlToValidate="txtResidDomProposedRequirement"
                                            ValidationGroup="WaterRequirementDetails" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtResidDomProposed" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtResidDomProposedRequirement" ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ForeColor="Red"
                                            ...
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtResidDomDaysInYear" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtResidDomNoOfOperationalDaysInYear" ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtGreenDevelEnviMaintProposedRequirement" runat="server" Width="95%"
                                            onblur="cal1()" MaxLength="9"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvtxtGreenDevelEnviMaintProposedRequirement" runat="server"
                                            ForeColor="Red" Display="Dynamic" ControlToValidate="txtGreenDevelEnviMaintProposedRequirement"
                                            ValidationGroup="WaterRequirementDetails" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtGreenDevelProposed" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtGreenDevelEnviMaintProposedRequirement"
                                            ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvtxtOtherUseExistRequirement" runat="server" ForeColor="Red"
                                            ...
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtOtherUseExist" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtOtherUseExistRequirement" ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOtherUseProposedRequirement" runat="server" Width="95%" onblur="cal1()"
                                            MaxLength="9"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvtxtOtherUseProposedRequirement" runat="server"
                                            ForeColor="Red" Display="Dynamic" ControlToValidate="txtOtherUseProposedRequirement"
                                            ValidationGroup="WaterRequirementDetails" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtOtherUseProposed" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtOtherUseProposedRequirement" ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOtherUseTotalRequirement" runat="server" Width="95%" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOtherUseNoOfOperationalDaysInYear" runat="server" Width="95%"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ForeColor="Red"
                                            ...
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revtxtOtherUseDaysInYear" runat="server" Display="Dynamic"
                                            ForeColor="Red" ControlToValidate="txtOtherUseNoOfOperationalDaysInYear" ValidationGroup="WaterRequirementDetails"></asp:RegularExpressionValidator>
