<%@ Page Title="NOCAP-Industrial Application" Language="C#" MaintainScrollPositionOnPostback="true"
    ...
    CodeFile="DetailsExistingGroundwaterAbstractionStructure.aspx.cs" Inherits="ExternalUser_IndustrialRenew_DetailsExistingGroundwaterAbstractionStructure"
    Theme="Skin" %>
            ...
            <td>
                <div>
                    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                        <tr>
                            <td colspan="2">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    RENEW - INDUSTRIAL USE: 3. Groundwater Abstraction Structure- Existing
                                </div>
                            </td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <b>3 (a). Groundwater Abstraction Structure- Existing </b>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 35%">
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="revtxtNumbeOfExistingGAS" runat="server" ForeColor="Red"
                                    ControlToValidate="txtNumbeOfExistingGAS" Display="Dynamic" ValidationGroup="RecycledWaterUsage"></asp:RegularExpressionValidator>
                                <asp:RangeValidator ID="RangeValidator1" runat="server" Type="Integer" ControlToValidate="txtNumbeOfExistingGAS"
                                    Display="Dynamic" ForeColor="Red" ValidationGroup="RecycledWaterUsage" ErrorMessage="Value can't be more than 1000"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RangeValidator ID="RngValYearOfConstruction" runat="server" ControlToValidate="txtYearOfConstruction"
                                        Display="Dynamic" Type="Integer" MinimumValue="1900" ForeColor="Red" ErrorMessage="Invalid Year"
