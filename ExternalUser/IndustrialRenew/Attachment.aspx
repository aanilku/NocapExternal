<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    AutoEventWireup="true" CodeFile="Attachment.aspx.cs" Inherits="ExternalUser_IndustrialRenew_Attachment"
        ...
        <tr>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td>
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INDUSTRIAL USE: Attachment
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: right">(<span class="style8">*</span>)- Mandatory Fields, (<span class="style8">$</span>)-
                                        ...
                                        <span class="Coumpulsory">*</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtExistingNOC"
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:GridView ID="gvExistingNOC" runat="server" ShowHeaderWhenEmpty="true" CssClass="SubFormWOBG"
                                                        AutoGenerateColumns="False" DataKeyNames="IndustrialRenewApplicationCode,AttachmentCode,AttachmentCodeSerialNumber"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewExistingNOCFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" valign="top">
                                        ...
                                        <span class="Coumpulsory">*</span>
                                                                ...
                                                                <asp:Label ID="lblRainWaterHarvesting" CssClass="Clicked" runat="server" Text="Details of Rainwater Harvesting / Artificial Recharge Measures"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:GridView ID="gvRainwaterHarvesting" runat="server" AutoGenerateColumns="False"
                                                        CssClass="SubFormWOBG" DataKeyNames="IndustrialRenewApplicationCode,AttachmentCode,AttachmentCodeSerialNumber"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewRainwaterHarvestingFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="SubFormWOBG" width="100%">
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Label runat="server" Visible="false" ID="lblComplianceConditionNOC2">
                                        <span class="Coumpulsory">*</span>
                                                                </asp:Label>
                                                                <asp:Label ID="lblComplianceConditionNOC" CssClass="Clicked" runat="server" Text="Compliance Condition NOC"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:GridView ID="gvINDRenewComplianceConditionNOC" runat="server" AutoGenerateColumns="False"
                                                                    CssClass="SubFormWOBG" ShowHeaderWhenEmpty="true" Width="100%" OnRowDataBound="gvINDRenewComplianceConditionNOC_RowDataBound"
                                                                    OnRowCommand="gvINDRenewComplianceConditionNOC_RowCommand">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Sr.No.">
                                                                            <ItemTemplate>
                                                                                <span>
                                                                ...
                                                                <asp:TextBox ID="txtAttachmentNameCompCondNOC" runat="server"></asp:TextBox>
                                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAttachmentNameCompCondNOC"
                                                                                    Display="Dynamic" ForeColor="Red" ErrorMessage="Required"
                                                                                    ValidationGroup='<%# System.Web.HttpUtility.HtmlEncode(Eval("ComplianceConditionCode")) %>'></asp:RequiredFieldValidator>
                                                                                ...
                                                                                <asp:Button ID="btnUploadCompCondNOC" runat="server" Text="Upload"
                                                                                    ValidationGroup='<%# System.Web.HttpUtility.HtmlEncode(Eval("ComplianceConditionCode")) %>'
                                                                                    CommandName="UploadFileForCompCondNOC" /><br />
                                                                                <asp:Label ID="lblMessageINDCompCondAttachment" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:GridView ID="gvCompCondNOCAttachment" runat="server" AutoGenerateColumns="False"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField>
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton ID="lnkIndustrialCompCondNOCAttachmentView" OnCommand="lnkIndustrialCompCondNOCAttachmentView_Click"
                                                                                                    runat="server" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                                                                                    CommandName="View">View</asp:LinkButton>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField>
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                                                                ...
                                                                                <asp:Label ID="lblMessageINDCompCondNOCAttachmentDelete" runat="server" Text="">
                                                                                </asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvAffidavit" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvSourceofAvailabilityofSurfaceWater" runat="server" ShowHeaderWhenEmpty="true"
                                                        ...
                                                        DataKeyNames="IndustrialRenewApplicationCode,AttachmentCode,AttachmentCodeSerialNumber"
                                                        Width="100%"
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton runat="server"
                                                                        CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                                                        OnCommand="ViewFile">View</asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Delete">
                                ...
                                <tr runat="server" visible="false">
                                    ...
                                    <td colspan="4" valign="top">
                                        ...
                                        <span class="Coumpulsory">*</span>
                                                                ...
                                                                <asp:Label ID="lblBharatKosh" CssClass="Clicked" runat="server" Text="Bharat Kosh Reciept Attachment (Processing Fee)"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvBharatKoshReciept" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnBharatKoshRecieptViewFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                        ...
                                        <span class="Coumpulsory">*</span>
                                                        ...
                                                        <tr>
                                                            <td colspan="3">
                                                                ...
                                                                &nbsp;or&nbsp;                                                                                                                                                                                  
                                                                <asp:LinkButton ID="lbtnPrint" runat="server" PostBackUrl="~/ExternalUser/IndustrialRenew/Reports/INDSADRenewReportViewer.aspx">click here</asp:LinkButton>
                                                                &nbsp; &nbsp;<br />
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvApplicationSignatureSeal" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnAplicationSignatureSealViewFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                                    ...
                                                    &nbsp;<asp:Label ID="lblMessageApplicationSignatureSeal" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <span class="Coumpulsory">*</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtExtraAttachment"
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvExtra" runat="server" AutoGenerateColumns="False" CssClass="SubFormWOBG"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnExtraViewFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="SubFormWOBG" width="100%">
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Label runat="server" Visible="false" ID="lblGroundwaterAvailabilityReport2">
                                        <span class="Coumpulsory">*</span>
                                                                </asp:Label>
                                                                <asp:Label ID="lblGroundwaterAvailabilityReport" CssClass="Clicked" runat="server" Text="Groundwater Availability Report"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvGroundwaterAvailability" runat="server" ShowHeaderWhenEmpty="true"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewGroundwaterAvailabilityFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvUndertaking" runat="server" AutoGenerateColumns="False" CssClass="SubFormWOBG"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewUndertakingFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="SubFormWOBG" width="100%">
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Label runat="server" Visible="false" ID="lblComplianceConditionNOCOther2">
                                        <span class="Coumpulsory">*</span>
                                                                </asp:Label>
                                                                <asp:Label ID="lblComplianceConditionNOCOther" runat="server" CssClass="Clicked" Text="Compliance Condition NOC - Other"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="gvINDRenewComplianceConditionNOCOther" runat="server" AutoGenerateColumns="False"
                                                        CssClass="SubFormWOBG" ShowHeaderWhenEmpty="true" Width="100%" OnRowCommand="gvINDRenewComplianceConditionNOCOther_RowCommand">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Sr.No.">
                                                                <ItemTemplate>
                                                                    <span>
                                                            ...
                                                            <asp:TemplateField HeaderText="File Upload" ItemStyle-Width="28%">
                                                                ...
                                                                <asp:TextBox ID="txtAttachmentNameCompCondNOCOther" runat="server"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAttachmentNameCompCondNOCOther"
                                                                        Display="Dynamic" ForeColor="Red" ErrorMessage="Required"
                                                                        ValidationGroup='<%# System.Web.HttpUtility.HtmlEncode(Eval("ComplianceConditionNOCSerialNumber")) %>'></asp:RequiredFieldValidator>
                                                                    <asp:RegularExpressionValidator runat="server"
                                                                    ...
                                                                    <asp:Label ID="lblMessageINDCompCondAttachmentOther" runat="server" Text=""></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Attachments">
                                                                <ItemTemplate>
                                                                    <asp:GridView ID="gvCompCondNOCAttachmentOther" runat="server" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField>
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lnkIndustrialCompCondNOCAttachmentViewOther" OnCommand="lnkIndustrialCompCondNOCAttachmentViewOther_Click"
                                                                                        runat="server" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                                                                        CommandName="View">View</asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                    ...
                                                                    <asp:Label ID="lblMessageINDCompCondNOCAttachmentOtherDelete" runat="server" Text="">
                                                                    </asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                        ...
                                        <span class="Coumpulsory">*</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator  runat="server" ControlToValidate="txtSitePlanAttachment"
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel ID="UpdatePanelSitePlan" runat="server">
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:Button ID="btnUploadSitePlan" runat="server" Text="Upload" 
                                                                             OnClick="btnUploadSitePlan_Click"
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvSitePlan" runat="server" CssClass="SubFormWOBG" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewFile" runat="server" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                ...
                                <%--  <tr runat="server" visible="false">
                                    ...
                                    DataKeyNames="IndustrialRenewApplicationCode,AttachmentCode,AttachmentCodeSerialNumber"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewCertifiedRevenueSketchFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                ...
                                <%--  <tr runat="server" visible="false">
                                    ...
                                    DataKeyNames="IndustrialRenewApplicationCode,AttachmentCode,AttachmentCodeSerialNumber"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewReasonForNotApplyingBeforeFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="SubFormWOBG" width="100%">
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Label runat="server" Visible="false" ID="lblEncloseFlowChart2">
                                        <span class="Coumpulsory">*</span>
                                                                </asp:Label>
                                                                <asp:Label ID="lblEncloseFlowChart" CssClass="Clicked" runat="server" Text="Enclose Flow Chart of Activity and Requirement of Water"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                ...
                                <%--    <tr runat="server" visible="false">
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="SubFormWOBG" width="100%">
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Label runat="server" Visible="false" ID="lblCopyofReferralLetter2">
                                        <span class="Coumpulsory">*</span>
                                                                </asp:Label>
                                                                <asp:Label ID="lblCopyofReferralLetter" CssClass="Clicked" runat="server" Text="Copy of Referral Letter Seeking NOC from CGWA"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                    ...
                                    DataKeyNames="IndustrialRenewApplicationCode,AttachmentCode,AttachmentCodeSerialNumber"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnViewReferralLetterFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialNewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'>View</asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Delete">
                                                                <ItemTemplate>
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="SubFormWOBG" width="100%">
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Label runat="server" Visible="false" ID="lblNonPollutingEffluentAttachment2">
                                        <span class="Coumpulsory">*</span>
                                                                </asp:Label>
                                                                <asp:Label ID="lblNonPollutingEffluentAttachment" CssClass="Clicked" runat="server" Text="Non-Polluting Effluent Attachment"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtNonPollutingAttachment"
                                                ...
                                                <td colspan="3">
                                                    <asp:GridView ID="gvNonPolluting" runat="server" AutoGenerateColumns="False" CssClass="SubFormWOBG"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View File">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnNonPollutingViewFile" runat="server" CommandArgument='<%# System.Web.HttpUtility.HtmlEncode(Eval("IndustrialNewApplicationCode") + "," + Eval("AttachmentCode") + "," + Eval("AttachmentCodeSerialNumber"))%>'>View</asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Delete">
                                                                <ItemTemplate>
