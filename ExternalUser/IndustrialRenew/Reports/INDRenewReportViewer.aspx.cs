...
public partial class ExternalUser_IndustrialRenew_Reports_INDRenewReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationRenewCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Industrial/Renew/PrintApplication/IndustrialRenewUseApplicationforExternal";
