<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    AutoEventWireup="true" CodeFile="IndustrialRenewDetail.aspx.cs" Inherits="ExternalUser_IndustrialRenew_RenewalDetail_IndustrialRenewDetail" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="gvMainGrid" runat="server" AutoGenerateColumns="false" CssClass="SubFormWOBG"
                                OnRowDataBound="gvMainGrid_RowDataBound" DataKeyNames="IndustrialFirstApplicationCode"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdnIndustrialFirstApplicationCode" runat="server" Value='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialFirstApplicationCode")) %>' />
                                            ...
                                            <asp:GridView ID="grdRenewIndustrialApplication" runat="server" ShowHeaderWhenEmpty="true"
                                                OnRowDataBound="grdRenewIndustrialApplication_RowDataBound" DataKeyNames="IndustrialRenewApplicationCode,LinkDepth"
                                                OnRowCommand="grdRenewIndustrialApplication_RowCommand" PageSize="8" AllowPaging="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="lbtnView" runat="server" OnCommand="lbtnViewStatus_Click" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode")) %>'>View</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtn_Print" runat="server" PostBackUrl="~/ExternalUser/IndustrialRenew/Reports/INDRenewReportViewer.aspx"
                                                                CommandName="IndustrialRenewApplicationCode" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode")) %>'>Print</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText=" Issued NOC" ItemStyle-Width="100px" HeaderStyle-Width="150px">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkNOCNumber" runat="server" CommandName="NOCNumber" Text='<%#System.Web.HttpUtility.HtmlEncode(Eval("NOCNumber"))%>'
                                                                Enabled="false" />
                                                            <asp:LinkButton ID="lnkCompliance" runat="server" 
                                                                OnCommand="lnkCompliance_Click"
                                                                Text="Self Compliance" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("IndustrialRenewApplicationCode"))%>' />
                                                            <br />
