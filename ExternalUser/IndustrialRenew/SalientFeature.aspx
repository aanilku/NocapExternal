<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="SalientFeature.aspx.cs" Inherits="ExternalUser_IndustrialRenew_SalientFeature" %>
                    ...
                    <tr>
                        <td>
                            <div class="div_IndAppHeading" style="padding-left:10px">
                                RENEW - INDUSTRIAL USE: 2. General Information- Exemption Letter
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <b><asp:Label ID="lblExemptionMessage" runat="server" Text=""></asp:Label></b>
                        </td>
                    </tr>
                    <tr>
                        <td>
