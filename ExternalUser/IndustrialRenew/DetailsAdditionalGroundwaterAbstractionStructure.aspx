<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    AutoEventWireup="true" CodeFile="DetailsAdditionalGroundwaterAbstractionStructure.aspx.cs"
    MaintainScrollPositionOnPostback="true" Inherits="ExternalUser_IndustrialRenew_DetailsAdditionalGroundwaterAbstractionStructure" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    RENEW - INDUSTRIAL USE: 3. Groundwater Abstraction Structure- Additional
                                </div>
                            </td>
                        </tr>
                        <tr>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvGASAdditional" runat="server" AutoGenerateColumns="false" CssClass="SubFormWOBG"
                    Caption="<th colspan='15'><b>Detail of Structures</b></th>" DataKeyNames="IndustrialRenewApplicationCode"
