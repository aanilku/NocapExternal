<%@ Page Title="NOCAP- Industrial Application for Renewal" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_IndustrialRenew_ExistingNOCIssued" %>
        ...
        <tr>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="4">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INDUSTRIAL USE: 1. General Information - Details of Existing NOC Issued
                                by CGWA
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <b>(iv) Details of Existing NOC Issued by CGWA</b>
                        </td>
                    </tr>
                    <tr>
                        <%--<td>
