<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="IndSubmitSuccess.aspx.cs"
    Inherits="ExternalUser_IndustrialRenew_IndSubmitSuccess" %>
                    ...
                    <tr>
                        <td>
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INDUSTRIAL USE: SUCCESSFUL SUBMISSION
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="margin-left: 50px; text-align: right">
                            ...
                            <asp:LinkButton ID="lbtnPrint" runat="server" PostBackUrl="~/ExternalUser/IndustrialRenew/Reports/INDRenewReportViewer.aspx"
                                OnClick="lbtnPrint_Click">Print Application</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblINDExistingNOCNumber" runat="server" Text="Label"></asp:Label><br />
                                        <asp:Label ID="lblINDNOCValidity" runat="server" Text="Label"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
