<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_IndustrialRenew_Submit" %>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - INDUSTRIAL USE: Final Submit
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <%-- Area Type - <asp:Label ID="lblAreaType" runat="server" Text="Label" Font-Bold="true"></asp:Label><br />--%>
                            Area Type Category -
                    ...
                    <tr>
                        ...
                        <td>
                            <%-- Area Type - <asp:Label ID="lblpresAreaType" runat="server" Text="Label" Font-Bold="true"></asp:Label><br />--%>
                            Area Type Category -
                            <asp:Label ID="lblpresAreaTypeCatagory" runat="server" Text="Label" Font-Bold="true"></asp:Label>
                        </td>
                    </tr>
                    <tr><td>(2).</td>
                        <td colspan="2"><b>Self Declaration</b></td></tr>
                   <tr>
                        <td></td>
                        <td colspan="4">
