<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="De-WateringAdditionalStructure.aspx.cs"
    Inherits="ExternalUser_MiningRenew_De_WateringAdditionalStructure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" class="SubFormWOBG" width="100%">
                                ...
                                <div class="block_left_inner">
                                    <div id="information" class="cont_left" style="display: block">
                                        <ul class="progressbar">
                                            ...
                                            <li class="active">Dewatering Additional Structure</li>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - MINING USE: De-Watering Additional Structure Detail</div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <b>(b). De-Watering Additional Structure</b>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtNoOfAdditionalStructure" runat="server" MaxLength="3" Width="200px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="txtNoOfAdditionalStructure"
                            ...
                            <asp:RegularExpressionValidator ID="revtxtNoOfAdditionalStructure" runat="server"
                                ForeColor="Red" ControlToValidate="txtNoOfAdditionalStructure" Display="Dynamic"
                                ValidationGroup="deWateringPrposedStructDetail"></asp:RegularExpressionValidator>
                            <asp:RangeValidator ID="RangeValidator1" runat="server" Type="Integer" ControlToValidate="txtNoOfAdditionalStructure"
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvdeWateringAdditional" runat="server" AutoGenerateColumns="false"
                    DataKeyNames="MiningRenewApplicationCode" Caption="<th colspan='15'><b>Detail of De-Watering Additional Structure</b></th>"
                    CssClass="SubFormWOBG" OnRowCommand="gvdeWateringAdditional_RowCommand" OnRowDataBound="gvdeWateringAdditional_RowDataBound"
                    ...
                    <EmptyDataTemplate>
                        No Records exist in De-Watering Additional Structure.
                    </EmptyDataTemplate>
                </asp:GridView>
            </td>
        </tr>
