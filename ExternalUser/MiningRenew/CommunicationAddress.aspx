<%@ Page Title="NOCAP- Mining Application for Renewal" Language="C#" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true"
    CodeFile="CommunicationAddress.aspx.cs" Inherits="ExternalUser_MiningRenew_CommunicationAddress" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - MINING USE: General Information - Communication Address
                            </div>
                        </td>
                    </tr>
                    <tr>
