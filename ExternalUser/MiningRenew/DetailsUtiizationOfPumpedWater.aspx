<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" MaintainScrollPositionOnPostback="true"
    AutoEventWireup="true" CodeFile="DetailsUtiizationOfPumpedWater.aspx.cs" Inherits="ExternalUser_MiningRenew_DetailsUtiizationOfPumpedWater" %>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="5">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - MINING USE: Details Utilization of Pumped Water
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5" class="FormProjName">
                            <b>Project Name:&nbsp;
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <b>Details of Utilization of Pumped Water (Please Attach Details) (m<sup>3</sup>/year)</b>(<span
                    ...
                    <tr>
                        ...
                        <td>
                            a). Water Supply <span class="Coumpulsory">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            b). Agriculture <span class="Coumpulsory">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            c). Green Belt Development <span class="Coumpulsory">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            d). Suppression of Dust <span class="Coumpulsory">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            e). Recharge <span class="Coumpulsory">*</span>
                        </td>
                        <td>
