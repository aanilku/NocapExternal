<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_MiningRenew_SelfDeclaration" %>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="3">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - MINING USE- Self Declaration
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <table class="SubFormWOBG" style="line-height: 25px" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Bharat Kosh Transaction Date:&nbsp; <span class="Coumpulsory">* </span>
                                    </td>
                                    <td>
                    ...
                    <%-- <tr>
                        ...
                        <td>
                            Bharat Kosh Transaction Ref. No:-&nbsp; <span class="Coumpulsory">* </span>(<span
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                          <%-- It is to certify that no case related to ground water withdrawal/ contamination
                            ...
                            <br />
                             <asp:Label ID="lblMessageUndertaking" runat="server" Visible="false"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td style="text-align: center" colspan="3">
                            ...
                            <asp:Button ID="txtNext" runat="server" Text="Next >>" OnClientClick="return ConfirmApproval();"
                                ValidationGroup="SelfDeclaration" OnClick="txtNext_Click" />
