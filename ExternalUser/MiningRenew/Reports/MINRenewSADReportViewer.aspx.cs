...
public partial class ExternalUser_MiningRenew_Reports_MINRenewSADReportViewer : System.Web.UI.Page
{
    ...
    void BindReport(string ApplicationRenewCode)
    {
        try
        {
            ...
            RvResult.ServerReport.ReportPath = NOCAPExternalUtility.GetReportFolderName() + "/Mining/Renew/PrintApplication/MiningRenewSADApplicationforExternal";
