<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    AutoEventWireup="true" CodeFile="MiningRenewDetail.aspx.cs" Inherits="ExternalUser_MiningRenew_RenewalDetail_MiningRenewDetail" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top">
                <table width="100%" class="SubFormWOBG" style="height: auto;">
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="width: 98%; height: 23px; line-height: 22px;
                                padding-left: 10px">
                    ...
                    <tr>
                        <td>
                            <strong>Name of Mining :</strong>
                        </td>
                        <td>
                            <asp:Label ID="lblMiningName" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="gvMainGrid" runat="server" AutoGenerateColumns="false" CssClass="SubFormWOBG"
                                OnRowDataBound="gvMainGrid_RowDataBound" DataKeyNames="MiningFirstApplicationCode"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdnMiningFirstApplicationCode" runat="server" Value='<%#System.Web.HttpUtility.HtmlEncode(Eval("MiningFirstApplicationCode")) %>' />
                                            ...
                                            <asp:GridView ID="grdRenewMiningApplication" runat="server" ShowHeaderWhenEmpty="true"
                                                OnRowDataBound="grdRenewMiningApplication_RowDataBound" DataKeyNames="MiningRenewApplicationCode,LinkDepth"
                                                OnRowCommand="grdRenewMiningApplication_RowCommand" PageSize="8" AllowPaging="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="lbtnView" runat="server" OnCommand="lbtnViewStatus_Click" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("MiningRenewApplicationCode")) %>'>View</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtn_Print" runat="server" PostBackUrl="~/ExternalUser/MiningRenew/Reports/MINRenewReportViewer.aspx"
                                                                CommandName="MiningRenewApplicationCode" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("MiningRenewApplicationCode")) %>'>Print</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText=" Issued NOC" ItemStyle-Width="100px" HeaderStyle-Width="150px">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="lnkCompliance" runat="server" OnCommand="lnkCompliance_Click"
                                                                Text="Self Compliance" CommandArgument='<%#System.Web.HttpUtility.HtmlEncode(Eval("MiningRenewApplicationCode"))%>' />
                                                       <br />
