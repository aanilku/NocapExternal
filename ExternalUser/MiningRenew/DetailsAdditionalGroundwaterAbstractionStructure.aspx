...
Inherits="ExternalUser_MiningRenew_DetailsAdditionalGroundwaterAbstractionStructure" %>
...
<table align="center" class="SubFormWOBG" width="100%">
                ...
                <div>
                    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                        <tr>
                            <td colspan="3">
                                <div class="div_IndAppHeading" style="padding-left: 10px">
                                    RENEW - MINING USE: Groundwater Abstraction Structure- Additional
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 40%">
                                b). Number of Additional Structures: <span class="Coumpulsory">
                                    *</span>
                            </td>
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="revtxtNumbeOfAdditionalGAS" runat="server" ForeColor="Red" Display="Dynamic"
                                    ControlToValidate="txtNumbeOfAdditionalGAS" ValidationGroup="GASProposedDetail"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                    </table>
                    <fieldset>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvGASAdditional" runat="server" AutoGenerateColumns="false" DataKeyNames="MiningRenewApplicationCode"
                    Caption="<th colspan='15'><b>Detail of Structures</b></th>" CssClass="SubFormWOBG"
                    OnRowCommand="gvGASAdditional_RowCommand" ShowHeaderWhenEmpty="true" 
                    OnRowDataBound="gvGASAdditional_RowDataBound">
                    <Columns>
