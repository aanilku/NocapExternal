<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master"
    ...
    Inherits="ExternalUser_MiningRenew_ComplianceConditionNOC" %>
        ...
        <tr>
                                ...
                                <div class="block_left_inner">
                                    <div id="information" class="cont_left" style="display: block">
                                        <ul class="progressbar">
                                            ...
                                            <li class="visited">Groundwater Abstraction Structure- Additoinal</li>
            ...
            <td>
                <table class="SubFormWOBG" width="100%" style="line-height: 25px">
                    <tr>
                        <td colspan="2">
                            <div class="div_IndAppHeading" style="padding-left: 10px">
                                RENEW - MINING USE: Compliance to the Conditions prescribed in the NOC
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <b>18(a). Compliance to the Conditions prescribed in the NOC</b>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
