<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true" CodeFile="MiningRenewStatus.aspx.cs" Inherits="ExternalUser_MiningRenew_Status_MiningRenewStatus" %>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                            ...
                                            <asp:GridView ID="grdVerificationMiningApplicationStatus" runat="server" ShowHeaderWhenEmpty="true"
                                                ...
                                                DataKeyNames="ApplicationCode,SerialNumber" OnRowDataBound="grdVerificationMiningApplicationStatus_RowDataBound">
                                                <Columns>
