<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true" CodeFile="SelfInspectionB.aspx.cs" Inherits="ExternalUser_SelfInspection_SelfInspectionB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" class="SubFormWOBG" width="100%" style="line-height: 20px">
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelNOC" runat="server">
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:Button ID="btnUploadNOC" runat="server" Text="Upload"
                                        OnClick="btnUploadNOC_Click" Style="width: 60px" />
        ...
        <tr>
            ...
            <td colspan="4">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelSiteInspection" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadSiteInspection" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressSiteInspection" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelSiteInspection">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblSiteInspectionWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            <td></td>
            <td colspan="6">
                <b>Self-Inspection of NOC Conditions:</b>
            </td>
        </tr>
        <tr>
            <td><b>(i)</b>
            ...
            <td colspan="6">
                <table align="left" class="SubFormWOBG" width="100%">
                    <tr>
                        ...
                        <td colspan="3"><b>Self Inspection</b></td>
                    </tr>
                    <tr>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlAnyVariation" runat="server" Width="225px" Height="16px" AutoPostBack="true" OnSelectedIndexChanged="ddlAnyVariation_SelectedIndexChanged">
                    <asp:ListItem Text="-----Select-----" Value=""></asp:ListItem>
            ...
            <td colspan="6">
                <table align="left" class="SubFormWOBG" width="100%">
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" Text="(Self Inspection)" Font-Bold="true"></asp:Label>
        ...
        <tr>
            ...
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelgeophotostruct" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadgeophotostruct" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressgeophotostruct" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelgeophotostruct">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblgeophotostructWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:DropDownList ID="ddlTeleInstalled" runat="server" Width="100px">
                    <asp:ListItem Text="-----Select-----" Value=""></asp:ListItem>
                    <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                    <asp:ListItem Text="No" Value="0"></asp:ListItem>
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td colspan="5">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:Label runat="server" ID="lblAnnual" Text="Attatch Certificate" Font-Bold="true">

                            </asp:Label>
                            <asp:UpdatePanel ID="UpdatePanelAnnualCalibration" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnFileUploadAnnualCalibration" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressAnnualCalibration" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelAnnualCalibration">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblAnnualCalibrationWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="5">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelGeoPhotowellfitted" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadGeoPhotowellfitted" />
                                </Triggers>
                                <ContentTemplate>


                                    <asp:FileUpload ID="FileUploadGeoPhotowellfitted" runat="server" />
                                    <asp:Button ID="btnUploadGeoPhotowellfitted" runat="server" Text="Upload"
                                        OnClick="btnUploadGeoPhotowellfitted_Click" Style="width: 60px" />

                                    <asp:UpdateProgress ID="UpdateProgressGeoPhotowellfitted" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelGeoPhotowellfitted">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblGeoPhotowellfittedWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td>
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelWQRSubmitted" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadWQRSubmitted" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressWQRSubmitted" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelWQRSubmitted">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblWQRSubmittedWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
                        ...
                        <td>
                            <asp:GridView ID="gvWQRSubmitted" runat="server" AutoGenerateColumns="False" CssClass="SubFormWOBG"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="View File">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbtnViewFile" runat="server" CommandName="ViewFile" 
            ...
            <td>
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelMineseepage" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadMineseepage" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressMineseepage" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelMineseepage">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblMineseepageWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <%--<asp:RequiredFieldValidator ID="rfvddltypestr" Display="Dynamic" runat="server"
                    ControlToValidate="ddltypestr" InitialValue="" ForeColor="Red" ValidationGroup="SelfCompliance">Required</asp:RequiredFieldValidator>--%>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelRainwaterharvesting" runat="server">
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressRainwaterharvesting" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelRainwaterharvesting">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblRainwaterharvestingWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td>
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelGroundwaterMonitoring" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadGroundwaterMonitoring" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressGroundwaterMonitoring" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelGroundwaterMonitoring">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblGroundwaterMonitoringWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelGroundWaterMonitoringData" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadGroundWaterMonitoringData" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressGroundWaterMonitoringData" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelGroundWaterMonitoringData">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblGroundWaterMonitoringDataWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="4">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelSTPETP" runat="server">
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnUploadSTPETP" />
                                </Triggers>
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressSTPETP" runat="server"
                                        AssociatedUpdatePanelID="UpdatePanelSTPETP">
                                        <ProgressTemplate>
                                            <asp:Label ID="lblSTPETPWait" runat="server" BackColor="#507CD1"
                                                Font-Bold="True" ForeColor="White" Text="Please wait ... Uploading file"></asp:Label>
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </ContentTemplate>
