<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalUser/ExternalUserMaster.master" AutoEventWireup="true" CodeFile="SelfInspectionViewer.aspx.cs" Inherits="ExternalUser_SelfInspection_Reports_SelfInspectionViewer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="SubFormWOBG" width="100%" style="line-height: 25px">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlAnyVariation" runat="server" Width="200px" Enabled="false">
                    <asp:ListItem Text="-----Select-----" Value=""></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="revtxtNOPiezo" runat="server" ForeColor="Red"
                                ControlToValidate="txtNOPiezo" Display="Dynamic" ValidationGroup="SelfInspection"></asp:RegularExpressionValidator>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="revtxtselfNOPiezo" runat="server" ForeColor="Red"
                                ControlToValidate="txtselfNOPiezo" Display="Dynamic" ValidationGroup="SelfInspection"></asp:RegularExpressionValidator>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="revtxtNOPiezoDWLR" runat="server" ForeColor="Red"
                                ControlToValidate="txtNOPiezoDWLR" Display="Dynamic" ValidationGroup="SelfInspection"></asp:RegularExpressionValidator>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="revtxtselfNOPiezoDWLR" runat="server" ForeColor="Red"
                                ControlToValidate="txtselfNOPiezoDWLR" Display="Dynamic" ValidationGroup="SelfInspection"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="revtxtpieDWLRTelem" runat="server" ForeColor="Red"
                                ControlToValidate="txtpieDWLRTelem" Display="Dynamic" ValidationGroup="SelfInspection"></asp:RegularExpressionValidator></td>
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="revtxtselfpieDWLRTelem" runat="server" ForeColor="Red"
                                ControlToValidate="txtselfpieDWLRTelem" Display="Dynamic" ValidationGroup="SelfInspection"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td><b>(xvi)</b></td>
            <td>
                <asp:CheckBox runat="server" ID="chkUndertaking" Enabled="false" />
                Undertaking</td>
