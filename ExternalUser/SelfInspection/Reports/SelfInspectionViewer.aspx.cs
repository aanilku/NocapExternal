...
public partial class ExternalUser_SelfInspection_Reports_SelfInspectionViewer : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (PreviousPage != null)
            {
                ...
                if (placeHolder != null)
                {
                    ...
                    {
                        Label SourceLabel1 = (Label)placeHolder.FindControl("lblApplicationCode");
                        if (SourceLabel1 != null && SourceLabel1.Text != "")
                            lblApplicationCodeFrom.Text = HttpUtility.HtmlEncode(SourceLabel1.Text);
                    }
        ...
        else
        {
            try
            {
                ...
                if (e.CommandArgument != null)
                {
                    ...
                    NOCAPExternalUtility.SelfInsepDownloadFiles(lng_applicationCode, int_attachmentCode, int_attachmentCodeSerialNumber);
